...
public class EnviosMasivosController {
	...
	ResponseEntity<EnviosMasivosDTO> cargasMasivasSearch(@RequestParam("numPagina") int numPagina,
			HttpServletRequest request, @RequestBody EnviosMasivosSearch filtros) {
	...
	ResponseEntity<EnviosMasivosDTO> busquedaEnvioMasivoSearch(@RequestParam("numPagina") int numPagina,
			HttpServletRequest request, @RequestBody EnviosMasivosSearch filtros) {
	...
	ResponseEntity<Error> programarEnvio(HttpServletRequest request,
			@RequestBody EnviosMasivosItem[] enviosProgramadosDto) {
	...
	ResponseEntity<Error> tarjetaConfiguracion(HttpServletRequest request,
			@RequestBody TarjetaConfiguracionDto datosTarjeta) {
	...
	ResponseEntity<EnviosMasivosDTO> duplicarEnvio(HttpServletRequest request,
			@RequestBody TarjetaConfiguracionDto datosTarjeta) {
	...
	ResponseEntity<PlantillaEnvioItem> obtenerAsuntoYCuerpo(HttpServletRequest request,
			@RequestBody TarjetaConfiguracionDto datosTarjeta) {
	...
	ResponseEntity<Error> guardarEtiquetasEnvio(HttpServletRequest request,
			@RequestBody TarjetaEtiquetasDTO tarjetaEtiquetas) {
	...
	ResponseEntity<ResponseDocumentoDTO> uploadFile(@RequestParam("idEnvio") Long idEnvio,
	...
	ResponseEntity<Error> guardarDocumentosEnvio(HttpServletRequest request,
			@RequestBody ResponseDocumentoDTO documento) {
	...
	public ResponseEntity<Resource> obtenerAdjunto(@RequestBody ResponseDocumentoDTO documentoDTO) throws Exception {
		...
		if (documentoDTO.getIdDocumento() != null && documentoDTO.getIdDocumento() instanceof Short) {
		...
		if (resource == null) {
			String filePath = _enviosMasivosService.getPathFicheroEnvioMasivo(documentoDTO.getIdInstitucion(),
					Long.valueOf(documentoDTO.getIdEnvio()), null);
			file = new File(filePath, documentoDTO.getRutaDocumento());
			try {
				if (file != null && !file.exists() && documentoDTO.getIdDocumento() != null && documentoDTO.getIdDocumento() instanceof String) {
					// si no lo encontramos para descargar es pq es del siga antiguo y se guardaba
					// con este nombre
					file = new File(filePath, documentoDTO.getIdInstitucion() + "_" + documentoDTO.getIdEnvio() + "_"
							+ (String) documentoDTO.getIdDocumento());
				}
	...
	ResponseEntity<FileInfoDTO> nombreFicheroLog(@RequestBody ResponseDocumentoDTO documentoDTO) {
		...
		File[] files = _enviosMasivosService.getFicherosLOGEnvioMasivo(documentoDTO.getIdInstitucion(),
				Long.valueOf(documentoDTO.getIdEnvio()));
		if (files != null) {
	...
	private Resource buroSMS(ResponseDocumentoDTO documentoDTO) {
		...
		if (documentoDTO.getIdInstitucion() != null && documentoDTO.getIdEnvio() != null
				&& !documentoDTO.getIdEnvio().trim().equals("") && documentoDTO.getIdDocumento() != null) {
			inputStreamResource = _enviosMasivosService.recuperaPdfBuroSMS(documentoDTO.getIdInstitucion(),
					Long.parseLong(documentoDTO.getIdEnvio()), (Short) documentoDTO.getIdDocumento());
		}
	...
	ResponseEntity<Error> guardarConsultaDest(HttpServletRequest request,
			@RequestBody ConsultaDestinatarioItem consulta) {
	...
	ResponseEntity<Error> desAsociarConsulta(HttpServletRequest request,
			@RequestBody ConsultaDestinatarioItem[] consulta) {
	...
	ResponseEntity<ComboConsultaInstitucionDTO> obtenerConsultas(@RequestParam("filtro") String filtro,
	...
	ResponseEntity<Error> asociarDestinatarioIndv(HttpServletRequest request,
			@RequestBody DestinatarioIndvEnvioMasivoItem destinatario) {
	...
	ResponseEntity<Error> desAsociarDestinatario(HttpServletRequest request,
			@RequestBody DestinatarioIndvEnvioMasivoItem[] destinatarios) {
	...
	ResponseEntity<EnviosMasivosDTO> obtenerDestinatarios(HttpServletRequest request,
			@RequestBody EnviosMasivosDTO enviosDTO) {
