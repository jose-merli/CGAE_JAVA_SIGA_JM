            ...
            if (usuarios != null && usuarios.size() > 0) {
                ...
                try {
                    ...
                    if (response != 1) {
                        ...
                        //String descripcionUnidadFamiliar = getDescripcionUnidadFamiliar(null, familiar, "INSERT");

                        //auditoriaCenHistoricoService.insertaCenHistorico(null, SigaConstants.CEN_TIPOCAMBIO.EJG_ANADIR_FAMILIAR_NUEVO, descripcionUnidadFamiliar, request, null);
                ...
                for (int i = 0; datos.size() > i; i++) {
                    ...
                    if (datos.get(i).getFechaBaja() == null) {
                        ...
                        if (record.getEncalidadde() != null && record.getEncalidadde().equals("3")) {
                            ...
                            //auditoriaCenHistoricoService.insertaCenHistorico(null, SigaConstants.CEN_TIPOCAMBIO.EJG_BORRAR_FAMILIAR, getDescripcionEjg(ejg, ejg, "UPDATE"), request, null);
...
//                    ScsPersonajg per = scsPersonajgMapper.selectByPrimaryKey(perKey);
                    ...
                    if (record.getFechabaja() != null) {
                        //auditoriaCenHistoricoService.insertaCenHistorico(null, SigaConstants.CEN_TIPOCAMBIO.EJG_BORRAR_FAMILIAR, getDescripcionUnidadFamiliar(record2, record, "UPDATE"), request, null);
                        //insertAuditoriaEJG("Familiar borrado", per.getNif(), null, usuarios.get(0), ejg);
                    } else {
                        //auditoriaCenHistoricoService.insertaCenHistorico(null, SigaConstants.CEN_TIPOCAMBIO.EJG_ACTIVAR_FAMILIAR_BORRADO, getDescripcionUnidadFamiliar(record2, record, "UPDATE"), request, null);
                        //insertAuditoriaEJG("Familiar activado", null, per.getNif(), usuarios.get(0), ejg);
                    }
