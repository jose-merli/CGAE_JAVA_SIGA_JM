...
public class FacturacionController {
	...
	@PostMapping("/facturacionsjcs/savePago")
	ResponseEntity<InsertResponseDTO> savePago(@RequestBody PagosjgItem pagosjgItem, HttpServletRequest request) {
		InsertResponseDTO response = facturacionServices.savePago(pagosjgItem, request);
		return new ResponseEntity<InsertResponseDTO>(response, HttpStatus.OK);
	}

	@PostMapping("/facturacionsjcs/updatePago")
	ResponseEntity<UpdateResponseDTO> updatePago(@RequestBody PagosjgItem pagosjgItem, HttpServletRequest request) {
		UpdateResponseDTO response = facturacionServices.updatePago(pagosjgItem, request);
		return new ResponseEntity<UpdateResponseDTO>(response, HttpStatus.OK);
	}
}
