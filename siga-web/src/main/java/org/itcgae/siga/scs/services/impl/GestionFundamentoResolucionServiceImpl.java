...
import org.itcgae.siga.scs.service.IGestionFundamentoResolucionService;
	...
	public ComboDTO getResoluciones(HttpServletRequest request) {
		...
		if (idInstitucion != null) {
			...
			if (usuarios != null && usuarios.size() > 0) {
				...
				List<ComboItem> comboItems = scsTiporesolucionExtendsMapper.getResoluciones(usuario.getIdlenguaje());
