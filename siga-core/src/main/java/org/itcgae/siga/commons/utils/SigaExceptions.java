...
public class SigaExceptions extends SigaExcBase {
...
private String param="NO PARAM";
  ...
  public SigaExceptions(Exception e, String msg, String param,
  ...
  public SigaExceptions(String msg, String param, String process, String errorCategory, String errortype)
  {
    super (msg);
    if (param!=null) this.param = param;
    if (msg!=null) this.mesg = msg;
   ...
   * @param msg String
   */
  public SigaExceptions(String msg) {
    super (msg);
    this.param = "";
    this.mesg = msg;
    this.process="0";
  ...
  public SigaExceptions(Exception e, String msg) {
    super (msg);
    this.param = "";
    this.mesg = msg;
    this.process="0";
