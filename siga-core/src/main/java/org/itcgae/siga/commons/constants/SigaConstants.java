...
public class SigaConstants {
	...
	public static enum OPERACION {
		...
		XUNTA_VALIDA_PRESENTACION(21),
		CENSO_OBTENER_COLEGIADOS(22),
		XUNTA_ENVIA_PRESENTACION(23),
		XUNTA_VERIFICA_PRESENTACION(24),
		...
		PERICLES_CONSULTAR_RESOLUCION(83),
		PERICLES_CONSULTAR_ESTADO(84),
		PERICLES_CONSULTAR_RESOLUCIONES(85),
		ARAGON_PROCESAR_RESOLUCIONES(86),
		PERICLES_CONSULTAR_ESTADOS(87),
		PERICLES_ENVIA_COMUNICACION(88),
		PERICLES_ENVIA_EXPEDIENTE_PENDIENTE(89),
		CAT_VALIDACION_EXPEDIENTES(90),
		CAT_ENVIO_EXPEDIENTES(91),
		CAT_RESPUESTA_FTP(92);
	...
	public static String SIGAWEB_VERSION = "1.0.115_0";
