...
public class BusquedaJuridicaItem {
	 ...
	 *
	 */
	public BusquedaJuridicaItem idPersona(String idPersona){
	 ...
	 *
	 */
	public BusquedaJuridicaItem nif(String nif){
		this.nif = nif;
		return this;
	}
	 ...
	 *
	 */
	public BusquedaJuridicaItem denominacion(String denominacion){
	 ...
	 *
	 */
	public BusquedaJuridicaItem abreviatura(String abreviatura){
	 ...
	 *
	 */
	public BusquedaJuridicaItem tipo(String tipo){
		this.tipo = tipo;
		return this;
	}
	 ...
	 *
	 */
	public BusquedaJuridicaItem numeroIntegrantes(String numeroIntegrantes){
	 ...
	 *
	 */
	public BusquedaJuridicaItem nombresIntegrantes(String nombresIntegrantes){
	 ...
	 *
	 */
	public BusquedaJuridicaItem fechaBaja(Date fechaBaja){
	...
	public boolean equals(java.lang.Object o) {
	    ...
	    BusquedaJuridicaItem busquedaJuridicaItem = (BusquedaJuridicaItem) o;
