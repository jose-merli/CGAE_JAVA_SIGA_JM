...
public class DatosBancariosSearchDTO {
	...
	/**
	 */
	public DatosBancariosSearchDTO idPersona(String idPersona){
	...
	/**
	 */
	public DatosBancariosSearchDTO idInstitucion(String idInstitucion){
	 ...
	 *
	 */
	public DatosBancariosSearchDTO historico(boolean historico){
