...
public class CalendarioEfectivo {
	...
	public CalendarioEfectivo(String fechaInicio, String fechaFin,
			...
			Vector seleccionFestivos, List<String> listaFestivos) {
		Iterator iter = null;
		SimpleDateFormat datef = new SimpleDateFormat("dd/MM/yyyy");
		SimpleDateFormat datef2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.S");
	...
	public PeriodoEfectivoItem next() {
		Punteroperiodo++;
		return ((PeriodoEfectivoItem) listaPeriodos.get(Punteroperiodo));
	} // next()
