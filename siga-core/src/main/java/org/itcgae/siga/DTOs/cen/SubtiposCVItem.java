...
public class SubtiposCVItem {
	Short idInstitucion;
	Short subTipo1IdInstitucion;
	 ...
	 */
	public Short getSubTipo2IdTipo() {
		return subTipo2IdTipo;
	}
	/**
	 * @param subTipo2IdTipo the subTipo2IdTipo to set
	 */
	public void setSubTipo2IdTipo(Short subTipo2IdTipo) {
	...
	/**
	 * @return the abreviaturaInstitucion1
	 */
	public String getAbreviaturaInstitucion1() {
		return abreviaturaInstitucion1;
	}
	/**
	 * @param abreviaturaInstitucion1 the abreviaturaInstitucion1 to set
	 */
	public void setAbreviaturaInstitucion1(String abreviaturaInstitucion1) {
		this.abreviaturaInstitucion1 = abreviaturaInstitucion1;
	}
	/**
	 * @return the abreviaturaInstitucion2
	 */
	public String getAbreviaturaInstitucion2() {
		return abreviaturaInstitucion2;
	}
	/**
	 * @param abreviaturaInstitucion2 the abreviaturaInstitucion2 to set
	 */
	public void setAbreviaturaInstitucion2(String abreviaturaInstitucion2) {
		this.abreviaturaInstitucion2 = abreviaturaInstitucion2;
	}
	/**
	 * @return the idtipocv
	 */
	...
	/**
	 * @return the tipocvDescripcion
	 */
	public String getTipocvDescripcion() {
		return tipocvDescripcion;
	}
	/**
	 * @param tipocvDescripcion the tipocvDescripcion to set
	 */
