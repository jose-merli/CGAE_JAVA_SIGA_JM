...
public class ColegiadoGeneralDTO {
	...
	/**
	 */
	public ColegiadoGeneralDTO ColegiadoItem(List<ColegiadoItem> colegiadoItem){
	...
	/**
	 */
	public ColegiadoGeneralDTO error(Error error){
		this.error = error;
		return this;
	}
	...
	public boolean equals(java.lang.Object o) {
	    ...
	    ColegiadoGeneralDTO colegiadoDTO = (ColegiadoGeneralDTO) o;
