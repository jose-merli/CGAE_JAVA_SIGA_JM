...
public class PermutaDTO {
	  private List<PermutaItem> permutaItems = new ArrayList<PermutaItem>();
	    private org.itcgae.siga.DTOs.gen.Error error = null;
	    
	    @JsonProperty("permutaItems")
		public List<PermutaItem> getPermutaItems() {
			return permutaItems;
		}
		public void setPermutaItems(List<PermutaItem> permutaItems) {
