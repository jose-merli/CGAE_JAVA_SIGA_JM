...
public class FichaDatosGeneralesDTO {
	 ...
	 *
	 */
	public FichaDatosGeneralesDTO FichaDatosColegialesItem(List<FichaDatosColegialesItem> fichaDatosColegialesItems){
	 ...
	 *
	 */
	public FichaDatosGeneralesDTO error(Error error){
		this.error = error;
		return this;
	}
