...
public class TarjetaAsistenciaResponse2Item implements Comparable<TarjetaAsistenciaResponse2Item> {
	...
	@Override
	public int compareTo(TarjetaAsistenciaResponse2Item that) {
