...
public class SolIncorporacionItem {
	...
	public String getIdTipoColegiacion() {
		return idTipoColegiacion;
	}
	public void setIdTipoColegiacion(String idTipoColegiacion) {
	...
	public String getIdModalidadDocumentacion() {
		return idModalidadDocumentacion;
	}
	public void setIdModalidadDocumentacion(String idModalidadDocumentacion) {
	...
	public int hashCode() {
		...
		result = prime * result + ((idTipoColegiacion == null) ? 0 : idTipoColegiacion.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SolIncorporacionItem other = (SolIncorporacionItem) obj;
		if (abonoCargo == null) {
		...
		if (cboCodigo == null) {
			if (other.cboCodigo != null)
				return false;
		} else if (!cboCodigo.equals(other.cboCodigo))
			return false;
		...
		if (idModalidadDocumentacion == null) {
			if (other.idModalidadDocumentacion != null)
				return false;
		} else if (!idModalidadDocumentacion.equals(other.idModalidadDocumentacion))
			return false;
		if (idPais == null) {
		...
		if (idTipo == null) {
			...
			return false;
		if (idTipoColegiacion == null) {
			if (other.idTipoColegiacion != null)
				return false;
		} else if (!idTipoColegiacion.equals(other.idTipoColegiacion))
			return false;
		...
		if (telefono2 == null) {
			...
			return false;
		if (tipoColegiacion == null) {
			if (other.tipoColegiacion != null)
				return false;
		} else if (!tipoColegiacion.equals(other.tipoColegiacion))
			return false;
