...
////////////////////CONSTRUCTORES ////////////////////
public CalendarioAutomatico (GuardiasTurnoItem beanGuardiasTurno , String fInicio, String fFin, List<String> vDiasFestivos)
{
//variables
String semana;
...
calendarioCGAE = new CalendarioEfectivo(fechaInicio,
								    fechaFin,
								    duracion,
								    unidadesDuracion,
								    periodo,
