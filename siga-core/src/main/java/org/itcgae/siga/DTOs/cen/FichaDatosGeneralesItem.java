...
public class FichaDatosGeneralesItem {
	 ...
	 *
	 */
	public FichaDatosGeneralesItem busquedaJuridicaItems(String idInstitucion){
	 ...
	 *
	 */
	public FichaDatosGeneralesItem idPersona(String idPersona){
	 ...
	 *
	 */
	public FichaDatosGeneralesItem nif(String nif){
		this.nif = nif;
		return this;
	}
	 ...
	 *
	 */
	public FichaDatosGeneralesItem denominacion(String denominacion){
	 ...
	 *
	 */
	public FichaDatosGeneralesItem abreviatura(String abreviatura){
	 ...
	 *
	 */
	public FichaDatosGeneralesItem fechaConstitucion(Date fechaConstitucion){
	 ...
	 *
	 */
	public FichaDatosGeneralesItem tipo(String tipo){
		this.tipo = tipo;
		return this;
	}
	 ...
	 *
	 */
	public FichaDatosGeneralesItem numeroIntegrantes(String numeroIntegrantes){
	 ...
	 *
	 */
	public FichaDatosGeneralesItem nombresIntegrantes(String nombresIntegrantes){
	 ...
	 *
	 */
	public FichaDatosGeneralesItem fechaBaja(Date fechaBaja){
	 ...
	 *
	 */
	public FichaDatosGeneralesItem idTipoIdentificacion(String idTipoIdentificacion){
	 ...
	 *
	 */
	public FichaDatosGeneralesItem sociedadProfesional(String sociedadProfesional){
	...
	public boolean equals(java.lang.Object o) {
	    ...
	    FichaDatosGeneralesItem busquedaJuridicaItem = (FichaDatosGeneralesItem) o;
