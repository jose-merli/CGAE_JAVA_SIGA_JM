...
public interface ScsDesignaMapper {
     ...
     */
    @Insert({
        "insert into SCS_DESIGNA (IDINSTITUCION, IDTURNO, ",
        "ANIO, NUMERO, FECHAENTRADA, ",
        "FECHAMODIFICACION, USUMODIFICACION, ",
        "ESTADO, FECHAFIN, ",
        "RESUMENASUNTO, DELITOS, ",
        "PROCURADOR, IDTIPODESIGNACOLEGIO, ",
        "OBSERVACIONES, DEFENSAJURIDICA, ",
        "IDPROCURADOR, IDINSTITUCION_PROCUR, ",
        "IDJUZGADO, IDINSTITUCION_JUZG, ",
        "FECHAANULACION, CODIGO, ",
        "NUMPROCEDIMIENTO, FECHAJUICIO, ",
        "IDPROCEDIMIENTO, FECHAESTADO, ",
        "IDPRETENSION, SUFIJO, ",
        "FECHAOFICIOJUZGADO, FECHARECEPCIONCOLEGIO, ",
        "FECHAALTA, ART27, ",
        "NIG, ANIOPROCEDIMIENTO, ",
        "FACTCONVENIO)",
    ...
    @Select({
        "select",
        "IDINSTITUCION, IDTURNO, ANIO, NUMERO, FECHAENTRADA, FECHAMODIFICACION, USUMODIFICACION, ",
        ...
        "FECHAALTA, ART27, NIG, ANIOPROCEDIMIENTO, FACTCONVENIO",
        "from SCS_DESIGNA",
        "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
          "and IDTURNO = #{idturno,jdbcType=DECIMAL}",
          "and ANIO = #{anio,jdbcType=DECIMAL}",
    ...
    @Update({
        "update SCS_DESIGNA",
        "set FECHAENTRADA = #{fechaentrada,jdbcType=TIMESTAMP},",
          "FECHAMODIFICACION = #{fechamodificacion,jdbcType=TIMESTAMP},",
          "USUMODIFICACION = #{usumodificacion,jdbcType=DECIMAL},",
          "ESTADO = #{estado,jdbcType=VARCHAR},",
          "FECHAFIN = #{fechafin,jdbcType=TIMESTAMP},",
          "RESUMENASUNTO = #{resumenasunto,jdbcType=VARCHAR},",
          "DELITOS = #{delitos,jdbcType=VARCHAR},",
          "PROCURADOR = #{procurador,jdbcType=VARCHAR},",
