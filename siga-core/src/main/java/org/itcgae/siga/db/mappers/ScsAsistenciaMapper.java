...
public interface ScsAsistenciaMapper {
	 ...
	 * @mbg.generated  Thu Dec 26 23:53:13 CET 2019
	 */
	@Delete({ "delete from SCS_ASISTENCIA", "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
	 ...
	 * @mbg.generated  Thu Dec 26 23:53:13 CET 2019
	 */
	@Insert({ "insert into SCS_ASISTENCIA (IDINSTITUCION, ANIO, ", "NUMERO, FECHAHORA, ", "IDTIPOASISTENCIA, IDTURNO, ",
			"IDGUARDIA, FECHAMODIFICACION, ", "USUMODIFICACION, IDPERSONACOLEGIADO, ", "OBSERVACIONES, INCIDENCIAS, ",
			"FECHAANULACION, MOTIVOSANULACION, ", "DELITOSIMPUTADOS, CONTRARIOS, ",
			"DATOSDEFENSAJURIDICA, FECHACIERRE, ", "IDTIPOASISTENCIACOLEGIO, DESIGNA_ANIO, ",
			"DESIGNA_NUMERO, IDPERSONAJG, ", "FACTURADO, PAGADO, ", "IDFACTURACION, DESIGNA_TURNO, ",
			"NUMERODILIGENCIA, NUMEROPROCEDIMIENTO, ", "COMISARIA, COMISARIAIDINSTITUCION, ",
			"JUZGADO, JUZGADOIDINSTITUCION, ", "IDESTADOASISTENCIA, FECHAESTADOASISTENCIA, ", "EJGIDTIPOEJG, EJGANIO, ",
			"EJGNUMERO, CODIGO, ", "NIG, IDPRETENSION, ", "ASISTIDOAUTORIZAEEJG, IDTIPOASISTIDO, ",
			"IDORIGENASISTENCIA, ASISTIDOSOLICITAJG, ", "FECHASOLICITUD, IDSOLICITUDCENTRALITA, ", "IDMOVIMIENTO)",
	 ...
	 * @mbg.generated  Thu Dec 26 23:53:13 CET 2019
	 */
	@Select({ "select", "IDINSTITUCION, ANIO, NUMERO, FECHAHORA, IDTIPOASISTENCIA, IDTURNO, IDGUARDIA, ",
			...
			"FECHASOLICITUD, IDSOLICITUDCENTRALITA, IDMOVIMIENTO", "from SCS_ASISTENCIA",
	 ...
	 * @mbg.generated  Thu Dec 26 23:53:13 CET 2019
	 */
	@Update({ "update SCS_ASISTENCIA", "set FECHAHORA = #{fechahora,jdbcType=TIMESTAMP},",
			"IDTIPOASISTENCIA = #{idtipoasistencia,jdbcType=DECIMAL},", "IDTURNO = #{idturno,jdbcType=DECIMAL},",
			"IDGUARDIA = #{idguardia,jdbcType=DECIMAL},",
			"FECHAMODIFICACION = #{fechamodificacion,jdbcType=TIMESTAMP},",
			"USUMODIFICACION = #{usumodificacion,jdbcType=DECIMAL},",
			"IDPERSONACOLEGIADO = #{idpersonacolegiado,jdbcType=DECIMAL},",
			"OBSERVACIONES = #{observaciones,jdbcType=VARCHAR},", "INCIDENCIAS = #{incidencias,jdbcType=VARCHAR},",
			"FECHAANULACION = #{fechaanulacion,jdbcType=TIMESTAMP},",
			"MOTIVOSANULACION = #{motivosanulacion,jdbcType=VARCHAR},",
			"DELITOSIMPUTADOS = #{delitosimputados,jdbcType=VARCHAR},", "CONTRARIOS = #{contrarios,jdbcType=VARCHAR},",
			...
			"DESIGNA_ANIO = #{designaAnio,jdbcType=DECIMAL},", "DESIGNA_NUMERO = #{designaNumero,jdbcType=DECIMAL},",
			...
			"EJGNUMERO = #{ejgnumero,jdbcType=DECIMAL},", "CODIGO = #{codigo,jdbcType=VARCHAR},",
			"NIG = #{nig,jdbcType=VARCHAR},", "IDPRETENSION = #{idpretension,jdbcType=DECIMAL},",
