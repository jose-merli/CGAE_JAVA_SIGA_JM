...
import org.itcgae.siga.db.entities.ScsOrigencajgExample.Criteria;
import org.itcgae.siga.db.entities.ScsOrigencajgExample.Criterion;
import org.itcgae.siga.db.entities.ScsOrigencajgExample;

public class ScsOrigencajgSqlProvider {
    /**
     ...
     */
    public String countByExample(ScsOrigencajgExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("SCS_ORIGENCAJG");
     ...
     * @mbg.generated Thu Jan 16 17:01:42 CET 2020
     */
    public String deleteByExample(ScsOrigencajgExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("SCS_ORIGENCAJG");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Thu Jan 16 17:01:42 CET 2020
     */
    public String insertSelective(ScsOrigencajg record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("SCS_ORIGENCAJG");
     ...
     * @mbg.generated Thu Jan 16 17:01:42 CET 2020
     */
    public String selectByExample(ScsOrigencajgExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("IDORIGENCAJG");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ScsOrigencajg record = (ScsOrigencajg) parameter.get("record");
        ScsOrigencajgExample example = (ScsOrigencajgExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("SCS_ORIGENCAJG");
     ...
     * @mbg.generated Thu Jan 16 17:01:42 CET 2020
     */
    public String updateByPrimaryKeySelective(ScsOrigencajg record) {
        SQL sql = new SQL();
        sql.UPDATE("SCS_ORIGENCAJG");
        ...
        sql.WHERE("IDORIGENCAJG = #{idorigencajg,jdbcType=DECIMAL}");
     ...
     * @mbg.generated Thu Jan 16 17:01:42 CET 2020
     */
    protected void applyWhere(SQL sql, ScsOrigencajgExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
