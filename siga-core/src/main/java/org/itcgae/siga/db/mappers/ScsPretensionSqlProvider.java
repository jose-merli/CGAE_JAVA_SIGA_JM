...
import org.itcgae.siga.db.entities.ScsPretensionExample.Criteria;
import org.itcgae.siga.db.entities.ScsPretensionExample.Criterion;
import org.itcgae.siga.db.entities.ScsPretensionExample;

public class ScsPretensionSqlProvider {
	 ...
	 */
	public String countByExample(ScsPretensionExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("SCS_PRETENSION");
	 ...
	 * @mbg.generated  Fri Dec 13 10:51:27 CET 2019
	 */
	public String deleteByExample(ScsPretensionExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("SCS_PRETENSION");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Fri Dec 13 10:51:27 CET 2019
	 */
	public String insertSelective(ScsPretension record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("SCS_PRETENSION");
	 ...
	 * @mbg.generated  Fri Dec 13 10:51:27 CET 2019
	 */
	public String selectByExample(ScsPretensionExample example) {
		SQL sql = new SQL();
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		ScsPretension record = (ScsPretension) parameter.get("record");
		ScsPretensionExample example = (ScsPretensionExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("SCS_PRETENSION");
		if (record.getIdinstitucion() != null) {
	 ...
	 * @mbg.generated  Fri Dec 13 10:51:27 CET 2019
	 */
	public String updateByPrimaryKeySelective(ScsPretension record) {
		SQL sql = new SQL();
		sql.UPDATE("SCS_PRETENSION");
		if (record.getDescripcion() != null) {
	 ...
	 * @mbg.generated  Fri Dec 13 10:51:27 CET 2019
	 */
	protected void applyWhere(SQL sql, ScsPretensionExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
