...
public interface ModModeloPlantillaenvioMapper {
	...
	@Insert({ "insert into MOD_MODELO_PLANTILLAENVIO (IDMODELOCOMUNICACION, IDPLANTILLAENVIOS, ",
			"IDINSTITUCION, FECHAMODIFICACION, ", "USUMODIFICACION, PORDEFECTO, ", "FECHABAJA)",
			"values (#{idmodelocomunicacion,jdbcType=DECIMAL}, #{idplantillaenvios,jdbcType=DECIMAL}, ",
			"#{idinstitucion,jdbcType=DECIMAL}, #{fechamodificacion,jdbcType=TIMESTAMP}, ",
			"#{usumodificacion,jdbcType=DECIMAL}, #{pordefecto,jdbcType=VARCHAR}, ",
	 ...
	 * @mbg.generated  Fri Jan 18 12:42:32 CET 2019
	 */
	@Select({ "select", "IDMODELOCOMUNICACION, IDPLANTILLAENVIOS, IDINSTITUCION, FECHAMODIFICACION, USUMODIFICACION, ",
