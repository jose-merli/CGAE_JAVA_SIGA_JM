...
public interface PysServiciosinstitucionMapper {
	...
	@Select({ "select", "IDINSTITUCION, IDTIPOSERVICIOS, IDSERVICIO, IDSERVICIOSINSTITUCION, DESCRIPCION, ",
			...
			"FACTURACIONPONDERADA, IDTIPOIVA, CODIGO_TRASPASONAV, CODIGOEXT", "from PYS_SERVICIOSINSTITUCION",
	...
	@Update({ "update PYS_SERVICIOSINSTITUCION", "set DESCRIPCION = #{descripcion,jdbcType=VARCHAR},",
			...
			"CODIGOEXT = #{codigoext,jdbcType=VARCHAR}", "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
			"and IDTIPOSERVICIOS = #{idtiposervicios,jdbcType=DECIMAL}",
			"and IDSERVICIO = #{idservicio,jdbcType=DECIMAL}",
			"and IDSERVICIOSINSTITUCION = #{idserviciosinstitucion,jdbcType=DECIMAL}" })
