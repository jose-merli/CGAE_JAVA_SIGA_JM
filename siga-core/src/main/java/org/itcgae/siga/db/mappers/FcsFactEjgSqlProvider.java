...
import org.itcgae.siga.db.entities.FcsFactEjgExample.Criteria;
import org.itcgae.siga.db.entities.FcsFactEjgExample.Criterion;
import org.itcgae.siga.db.entities.FcsFactEjgExample;

public class FcsFactEjgSqlProvider {
	 ...
	 */
	public String countByExample(FcsFactEjgExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("FCS_FACT_EJG");
	 ...
	 * @mbg.generated  Thu Dec 19 19:42:16 CET 2019
	 */
	public String deleteByExample(FcsFactEjgExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("FCS_FACT_EJG");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Thu Dec 19 19:42:16 CET 2019
	 */
	public String insertSelective(FcsFactEjg record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("FCS_FACT_EJG");
	 ...
	 * @mbg.generated  Thu Dec 19 19:42:16 CET 2019
	 */
	public String selectByExample(FcsFactEjgExample example) {
		SQL sql = new SQL();
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		FcsFactEjg record = (FcsFactEjg) parameter.get("record");
		FcsFactEjgExample example = (FcsFactEjgExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("FCS_FACT_EJG");
		if (record.getIdinstitucion() != null) {
	 ...
	 * @mbg.generated  Thu Dec 19 19:42:16 CET 2019
	 */
	public String updateByPrimaryKeySelective(FcsFactEjg record) {
		SQL sql = new SQL();
		sql.UPDATE("FCS_FACT_EJG");
		if (record.getIdpersona() != null) {
	 ...
	 * @mbg.generated  Thu Dec 19 19:42:16 CET 2019
	 */
	protected void applyWhere(SQL sql, FcsFactEjgExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
