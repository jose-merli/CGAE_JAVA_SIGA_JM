...
public class CenTipoidentificacionSqlProvider {
	 ...
	 */
	public String countByExample(CenTipoidentificacionExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("CEN_TIPOIDENTIFICACION");
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String deleteByExample(CenTipoidentificacionExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("CEN_TIPOIDENTIFICACION");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String insertSelective(CenTipoidentificacion record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("CEN_TIPOIDENTIFICACION");
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String selectByExample(CenTipoidentificacionExample example) {
		SQL sql = new SQL();
		if (example != null && example.isDistinct()) {
			sql.SELECT_DISTINCT("IDTIPOIDENTIFICACION");
		} else {
		...
		sql.FROM("CEN_TIPOIDENTIFICACION");
		applyWhere(sql, example, false);
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		CenTipoidentificacion record = (CenTipoidentificacion) parameter.get("record");
		CenTipoidentificacionExample example = (CenTipoidentificacionExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("CEN_TIPOIDENTIFICACION");
		if (record.getIdtipoidentificacion() != null) {
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String updateByPrimaryKeySelective(CenTipoidentificacion record) {
		SQL sql = new SQL();
		sql.UPDATE("CEN_TIPOIDENTIFICACION");
		if (record.getDescripcion() != null) {
		...
		sql.WHERE("IDTIPOIDENTIFICACION = #{idtipoidentificacion,jdbcType=DECIMAL}");
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	protected void applyWhere(SQL sql, CenTipoidentificacionExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
