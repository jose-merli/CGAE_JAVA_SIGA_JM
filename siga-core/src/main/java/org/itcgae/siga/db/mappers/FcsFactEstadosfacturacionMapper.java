...
public interface FcsFactEstadosfacturacionMapper {
     ...
     */
    @Delete({
        "delete from FCS_FACT_ESTADOSFACTURACION",
     ...
     */
    @Insert({
        "insert into FCS_FACT_ESTADOSFACTURACION (IDINSTITUCION, IDFACTURACION, ",
        "IDESTADOFACTURACION, FECHAESTADO, ",
        ...
        "#{idordenestado,jdbcType=DECIMAL})"
    })
    ...
    @Select({
        "select",
        "IDINSTITUCION, IDFACTURACION, IDESTADOFACTURACION, FECHAESTADO, FECHAMODIFICACION, ",
        "USUMODIFICACION, IDORDENESTADO",
    ...
    int updateByExampleSelective(@Param("record") FcsFactEstadosfacturacion record, @Param("example") FcsFactEstadosfacturacionExample example);
    ...
    int updateByExample(@Param("record") FcsFactEstadosfacturacion record, @Param("example") FcsFactEstadosfacturacionExample example);
     ...
     */
    @Update({
        "update FCS_FACT_ESTADOSFACTURACION",
        "set FECHAMODIFICACION = #{fechamodificacion,jdbcType=TIMESTAMP},",
          "USUMODIFICACION = #{usumodificacion,jdbcType=DECIMAL},",
          "IDORDENESTADO = #{idordenestado,jdbcType=DECIMAL}",
        "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
          "and IDFACTURACION = #{idfacturacion,jdbcType=DECIMAL}",
          "and IDESTADOFACTURACION = #{idestadofacturacion,jdbcType=DECIMAL}",
          "and FECHAESTADO = #{fechaestado,jdbcType=TIMESTAMP}"
