...
public interface FacFacturaExtendsMapper extends FacFacturaMapper {
	...
	@Results({
			...
			@Result(column = "imptotalporpagar_max", property = "importePorPagarUlt", jdbcType = JdbcType.NUMERIC),
			@Result(column = "imptotalpagado_max", property = "importePagadoUlt", jdbcType = JdbcType.NUMERIC),
