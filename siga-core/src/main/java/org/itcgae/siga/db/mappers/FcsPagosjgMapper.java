...
public interface FcsPagosjgMapper {
     ...
     */
    @Insert({
        "insert into FCS_PAGOSJG (IDINSTITUCION, IDPAGOSJG, ",
        "IDFACTURACION, NOMBRE, ",
        "ABREVIATURA, FECHADESDE, ",
        "FECHAHASTA, CRITERIOPAGOTURNO, ",
        "IMPORTEREPARTIR, IMPORTEPAGADO, ",
        "IMPORTEOFICIO, IMPORTEGUARDIA, ",
        "IMPORTESOJ, IMPORTEEJG, ",
        "IMPORTEMINIMO, FECHAMODIFICACION, ",
        "USUMODIFICACION, CONTABILIZADO, ",
        "BANCOS_CODIGO, IDSUFIJO, ",
        "IDPROPSEPA, IDPROPOTROS)",
    ...
    @Select({
        "select",
        "IDINSTITUCION, IDPAGOSJG, IDFACTURACION, NOMBRE, ABREVIATURA, FECHADESDE, FECHAHASTA, ",
        ...
        "BANCOS_CODIGO, IDSUFIJO, IDPROPSEPA, IDPROPOTROS",
        "from FCS_PAGOSJG",
        "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
          "and IDPAGOSJG = #{idpagosjg,jdbcType=DECIMAL}"
    })
    ...
    @Update({
        "update FCS_PAGOSJG",
        "set IDFACTURACION = #{idfacturacion,jdbcType=DECIMAL},",
          ...
          "IMPORTEPAGADO = #{importepagado,jdbcType=DECIMAL},",
          "IMPORTEOFICIO = #{importeoficio,jdbcType=DECIMAL},",
          "IMPORTEGUARDIA = #{importeguardia,jdbcType=DECIMAL},",
          "IMPORTESOJ = #{importesoj,jdbcType=DECIMAL},",
          "IMPORTEEJG = #{importeejg,jdbcType=DECIMAL},",
          "IMPORTEMINIMO = #{importeminimo,jdbcType=DECIMAL},",
          ...
          "IDPROPSEPA = #{idpropsepa,jdbcType=DECIMAL},",
          "IDPROPOTROS = #{idpropotros,jdbcType=DECIMAL}",
        "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
          "and IDPAGOSJG = #{idpagosjg,jdbcType=DECIMAL}"
    })
