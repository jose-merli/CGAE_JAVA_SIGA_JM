...
public interface PysPeticioncomprasuscripcionExtendsMapper extends PysPeticioncomprasuscripcionMapper{
	...
	@Results({
			@Result(column = "FACHASOLICITUD", property = "fechaSolicitud", jdbcType = JdbcType.DATE),
			@Result(column = "IDPERSONA", property = "idPersona", jdbcType = JdbcType.VARCHAR),
			...
			@Result(column = "IDFORMADEPAGO", property = "idFormaPago", jdbcType = JdbcType.VARCHAR),
			@Result(column = "DESFROMADEPAGO", property = "desFormaPago", jdbcType = JdbcType.VARCHAR),
	...
	@Results({
		...
		@Result(column = "facturas", property = "facturas", jdbcType = JdbcType.VARCHAR),
		@Result(column = "fechaEfectiva", property = "fechaSuscripcion", jdbcType = JdbcType.VARCHAR),
		@Result(column = "fechaAnulada", property = "fechaBaja", jdbcType = JdbcType.VARCHAR),
		@Result(column = "solicitarBaja", property = "solicitarBaja", jdbcType = JdbcType.VARCHAR),
