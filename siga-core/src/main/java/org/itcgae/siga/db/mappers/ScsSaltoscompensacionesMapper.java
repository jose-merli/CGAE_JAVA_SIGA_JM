...
public interface ScsSaltoscompensacionesMapper {
     ...
     */
    @Delete({
        "delete from SCS_SALTOSCOMPENSACIONES",
     ...
     */
    @Insert({
        "insert into SCS_SALTOSCOMPENSACIONES (IDINSTITUCION, IDTURNO, ",
        "IDSALTOSTURNO, IDPERSONA, ",
        "SALTOOCOMPENSACION, FECHA, ",
        "FECHAMODIFICACION, USUMODIFICACION, ",
        "IDGUARDIA, MOTIVOS, ",
        "FECHACUMPLIMIENTO, IDCALENDARIOGUARDIAS, ",
        "IDCALENDARIOGUARDIASCREACION, TIPOMANUAL)",
    ...
    @Select({
        "select",
        "IDINSTITUCION, IDTURNO, IDSALTOSTURNO, IDPERSONA, SALTOOCOMPENSACION, FECHA, ",
    ...
    int updateByExampleSelective(@Param("record") ScsSaltoscompensaciones record, @Param("example") ScsSaltoscompensacionesExample example);
    ...
    int updateByExample(@Param("record") ScsSaltoscompensaciones record, @Param("example") ScsSaltoscompensacionesExample example);
    ...
    @Update({
        ...
        "set IDPERSONA = #{idpersona,jdbcType=DECIMAL},",
          ...
          "TIPOMANUAL = #{tipomanual,jdbcType=DECIMAL}",
        "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
          "and IDTURNO = #{idturno,jdbcType=DECIMAL}",
          "and IDSALTOSTURNO = #{idsaltosturno,jdbcType=DECIMAL}"
    })
