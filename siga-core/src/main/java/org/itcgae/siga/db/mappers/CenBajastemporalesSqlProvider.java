...
public class CenBajastemporalesSqlProvider {
	 ...
	 * @mbg.generated  Thu May 11 13:46:26 CEST 2023
	 */
	public String insertSelective(CenBajastemporales record) {
		SQL sql = new SQL();
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		CenBajastemporales record = (CenBajastemporales) parameter.get("record");
		...
		if (record.getFechabt() != null) {
			sql.SET("FECHABT = #{record.fechabt,jdbcType=TIMESTAMP}");
		}
		if (record.getTipo() != null) {
		...
		if (record.getValidado() != null) {
			sql.SET("VALIDADO = #{record.validado,jdbcType=CHAR}");
		}
		if (record.getFechaestado() != null) {
			sql.SET("FECHAESTADO = #{record.fechaestado,jdbcType=TIMESTAMP}");
		}
		if (record.getEliminado() != null) {
			sql.SET("ELIMINADO = #{record.eliminado,jdbcType=NUMERIC}");
		}
	 ...
	 * @mbg.generated  Thu May 11 13:46:26 CEST 2023
	 */
	public String updateByPrimaryKeySelective(CenBajastemporales record) {
		SQL sql = new SQL();
		sql.UPDATE("CEN_BAJASTEMPORALES");
		if (record.getTipo() != null) {
