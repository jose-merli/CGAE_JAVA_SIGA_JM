...
public interface FcsFacturacionjgMapper {
     ...
     */
    @Insert({
        "insert into FCS_FACTURACIONJG (IDINSTITUCION, IDFACTURACION, ",
        "FECHADESDE, FECHAHASTA, ",
        "NOMBRE, IMPORTETOTAL, ",
        "IMPORTEOFICIO, IMPORTEGUARDIA, ",
        "IMPORTESOJ, IMPORTEEJG, ",
        "PREVISION, REGULARIZACION, ",
        "FECHAMODIFICACION, USUMODIFICACION, ",
        "IDFACTURACION_REGULARIZA, NOMBREFISICO, ",
        "IDECOMCOLA)",
    ...
    @Select({
        "select",
        "IDINSTITUCION, IDFACTURACION, FECHADESDE, FECHAHASTA, NOMBRE, IMPORTETOTAL, ",
    ...
    int updateByExampleSelective(@Param("record") FcsFacturacionjg record, @Param("example") FcsFacturacionjgExample example);
     ...
     */
    @Update({
        "update FCS_FACTURACIONJG",
        "set FECHADESDE = #{fechadesde,jdbcType=TIMESTAMP},",
          ...
          "PREVISION = #{prevision,jdbcType=VARCHAR},",
          ...
          "NOMBREFISICO = #{nombrefisico,jdbcType=VARCHAR},",
