...
import org.itcgae.siga.db.entities.ScsMaestroestadosejgExample.Criteria;
import org.itcgae.siga.db.entities.ScsMaestroestadosejgExample.Criterion;
import org.itcgae.siga.db.entities.ScsMaestroestadosejgExample;

public class ScsMaestroestadosejgSqlProvider {
	 ...
	 */
	public String countByExample(ScsMaestroestadosejgExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("SCS_MAESTROESTADOSEJG");
	 ...
	 * @mbg.generated  Thu Nov 28 17:25:42 CET 2019
	 */
	public String deleteByExample(ScsMaestroestadosejgExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("SCS_MAESTROESTADOSEJG");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Thu Nov 28 17:25:42 CET 2019
	 */
	public String insertSelective(ScsMaestroestadosejg record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("SCS_MAESTROESTADOSEJG");
		...
		if (record.getVisiblecomision() != null) {
			sql.VALUES("VISIBLECOMISION", "#{visiblecomision,jdbcType=VARCHAR}");
		}
	 ...
	 * @mbg.generated  Thu Nov 28 17:25:42 CET 2019
	 */
	public String selectByExample(ScsMaestroestadosejgExample example) {
		SQL sql = new SQL();
		if (example != null && example.isDistinct()) {
			sql.SELECT_DISTINCT("IDESTADOEJG");
		} else {
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		ScsMaestroestadosejg record = (ScsMaestroestadosejg) parameter.get("record");
		ScsMaestroestadosejgExample example = (ScsMaestroestadosejgExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("SCS_MAESTROESTADOSEJG");
		if (record.getIdestadoejg() != null) {
		...
		if (record.getVisiblecomision() != null) {
			sql.SET("VISIBLECOMISION = #{record.visiblecomision,jdbcType=VARCHAR}");
		}
		if (record.getCodigoejis() != null) {
	 ...
	 * @mbg.generated  Thu Nov 28 17:25:42 CET 2019
	 */
	public String updateByPrimaryKeySelective(ScsMaestroestadosejg record) {
		SQL sql = new SQL();
		sql.UPDATE("SCS_MAESTROESTADOSEJG");
		if (record.getDescripcion() != null) {
		...
		if (record.getVisiblecomision() != null) {
			sql.SET("VISIBLECOMISION = #{visiblecomision,jdbcType=VARCHAR}");
		}
		if (record.getCodigoejis() != null) {
		...
		sql.WHERE("IDESTADOEJG = #{idestadoejg,jdbcType=DECIMAL}");
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Thu Nov 28 17:25:42 CET 2019
	 */
	protected void applyWhere(SQL sql, ScsMaestroestadosejgExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
