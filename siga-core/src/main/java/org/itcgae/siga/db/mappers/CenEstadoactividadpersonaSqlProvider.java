...
public class CenEstadoactividadpersonaSqlProvider {
	 ...
	 */
	public String countByExample(CenEstadoactividadpersonaExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("CEN_ESTADOACTIVIDADPERSONA");
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String deleteByExample(CenEstadoactividadpersonaExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("CEN_ESTADOACTIVIDADPERSONA");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String insertSelective(CenEstadoactividadpersona record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("CEN_ESTADOACTIVIDADPERSONA");
		if (record.getIdpersona() != null) {
			sql.VALUES("IDPERSONA", "#{idpersona,jdbcType=DECIMAL}");
		}
		if (record.getIdcodigo() != null) {
			sql.VALUES("IDCODIGO", "#{idcodigo,jdbcType=DECIMAL}");
		}
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String selectByExample(CenEstadoactividadpersonaExample example) {
		SQL sql = new SQL();
		...
		sql.FROM("CEN_ESTADOACTIVIDADPERSONA");
		applyWhere(sql, example, false);
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		CenEstadoactividadpersona record = (CenEstadoactividadpersona) parameter.get("record");
		CenEstadoactividadpersonaExample example = (CenEstadoactividadpersonaExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("CEN_ESTADOACTIVIDADPERSONA");
		if (record.getIdpersona() != null) {
			sql.SET("IDPERSONA = #{record.idpersona,jdbcType=DECIMAL}");
		}
		if (record.getIdcodigo() != null) {
			sql.SET("IDCODIGO = #{record.idcodigo,jdbcType=DECIMAL}");
		}
		if (record.getFechaestado() != null) {
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String updateByPrimaryKeySelective(CenEstadoactividadpersona record) {
		SQL sql = new SQL();
		sql.UPDATE("CEN_ESTADOACTIVIDADPERSONA");
		if (record.getFechaestado() != null) {
		...
		sql.WHERE("IDCODIGO = #{idcodigo,jdbcType=DECIMAL}");
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	protected void applyWhere(SQL sql, CenEstadoactividadpersonaExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
