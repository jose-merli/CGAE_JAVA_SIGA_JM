...
public interface CenNocolegiadoMapper {
     ...
     * This method corresponds to the database table USCGAE.CEN_NOCOLEGIADO
     *
     ...
     */
    @Insert({
        "insert into CEN_NOCOLEGIADO (IDINSTITUCION, IDPERSONA, ",
        "FECHAMODIFICACION, USUMODIFICACION, ",
        "SERIE, NUMEROREF, ",
        "SOCIEDADSJ, TIPO, ",
        "ANOTACIONES, PREFIJO_NUMREG, ",
        "CONTADOR_NUMREG, SUFIJO_NUMREG, ",
        "FECHAFIN, IDPERSONANOTARIO, ",
        "RESENA, OBJETOSOCIAL, ",
        "SOCIEDADPROFESIONAL, PREFIJO_NUMSSPP, ",
        "CONTADOR_NUMSSPP, SUFIJO_NUMSSPP, ",
        "NOPOLIZA, COMPANIASEG, ",
    ...
    @Results({
        ...
        @Result(column="ID_DATOS_REG", property="idDatosReg", jdbcType=JdbcType.DECIMAL)
    })
    ...
    @Select({
        "select",
        "IDINSTITUCION, IDPERSONA, FECHAMODIFICACION, USUMODIFICACION, SERIE, NUMEROREF, ",
        ...
        "CONTADOR_NUMSSPP, SUFIJO_NUMSSPP, NOPOLIZA, COMPANIASEG, IDENTIFICADORDS, FECHA_BAJA, ",
        "ID_DATOS_REG",
    ...
    int updateByExampleSelective(@Param("record") CenNocolegiado record, @Param("example") CenNocolegiadoExample example);
    ...
    @Update({
        ...
        "set FECHAMODIFICACION = #{fechamodificacion,jdbcType=TIMESTAMP},",
          ...
          "NUMEROREF = #{numeroref,jdbcType=VARCHAR},",
          "SOCIEDADSJ = #{sociedadsj,jdbcType=VARCHAR},",
          "TIPO = #{tipo,jdbcType=VARCHAR},",
          "ANOTACIONES = #{anotaciones,jdbcType=VARCHAR},",
          "PREFIJO_NUMREG = #{prefijoNumreg,jdbcType=VARCHAR},",
          "CONTADOR_NUMREG = #{contadorNumreg,jdbcType=DECIMAL},",
          "SUFIJO_NUMREG = #{sufijoNumreg,jdbcType=VARCHAR},",
          "FECHAFIN = #{fechafin,jdbcType=TIMESTAMP},",
          "IDPERSONANOTARIO = #{idpersonanotario,jdbcType=DECIMAL},",
          "RESENA = #{resena,jdbcType=VARCHAR},",
          ...
          "SUFIJO_NUMSSPP = #{sufijoNumsspp,jdbcType=VARCHAR},",
          "NOPOLIZA = #{nopoliza,jdbcType=VARCHAR},",
          "COMPANIASEG = #{companiaseg,jdbcType=VARCHAR},",
          "IDENTIFICADORDS = #{identificadords,jdbcType=VARCHAR},",
          "FECHA_BAJA = #{fechaBaja,jdbcType=TIMESTAMP},",
          "ID_DATOS_REG = #{idDatosReg,jdbcType=DECIMAL}",
        "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
          "and IDPERSONA = #{idpersona,jdbcType=DECIMAL}"
    })
