...
public class CenPersonaSqlExtendsProvider extends CenPersonaSqlProvider {
	...
	public String searchPerFisica(BusquedaPerFisicaSearchDTO busquedaPerFisicaSearchDTO, String idLenguaje, String idinstitucion) {
		...
		sql.GROUP_BY("PER.IDPERSONA, PER.NOMBRE , CONCAT(PER.APELLIDOS1 || ' ',PER.APELLIDOS2) , PER.APELLIDOS1 , PER.APELLIDOS2 , PER.NIFCIF , PER.FECHANACIMIENTO, I.ABREVIATURA , "
				+ "I.IDINSTITUCION, DECODE(COL.COMUNITARIO,0, COL.NCOLEGIADO,COL.NCOMUNITARIO) ,NVL(CA.DESCRIPCION, DECODE(PER.IDTIPOIDENTIFICACION,20,'SOCIEDAD','NO COLEGIADO')) ,"
				+ " DECODE(COL.SITUACIONRESIDENTE,'0','NO','1','SI') , ACT.IDACTIVIDADPROFESIONAL");
