...
public interface ModModelocomunicacionMapper {
	...
	@Insert({ "insert into MOD_MODELOCOMUNICACION (IDMODELOCOMUNICACION, NOMBRE, ", "ORDEN, IDINSTITUCION, ",
			...
			"VISIBLE, PORDEFECTO, ", "IDPLANTILLAENVIOS, IDTIPOENVIOS, ", "GENERAREXCEL)",
	...
	@Results({
			...
			@Result(column = "GENERAREXCEL", property = "generarexcel", jdbcType = JdbcType.DECIMAL) })
	...
	@Select({ "select", "IDMODELOCOMUNICACION, NOMBRE, ORDEN, IDINSTITUCION, DESCRIPCION, PRESELECCIONAR, ",
			...
			"PORDEFECTO, IDPLANTILLAENVIOS, IDTIPOENVIOS, GENERAREXCEL", "from MOD_MODELOCOMUNICACION",
			"where IDMODELOCOMUNICACION = #{idmodelocomunicacion,jdbcType=DECIMAL}" })
	@Results({
			@Result(column = "IDMODELOCOMUNICACION", property = "idmodelocomunicacion", jdbcType = JdbcType.DECIMAL, id = true),
			@Result(column = "NOMBRE", property = "nombre", jdbcType = JdbcType.VARCHAR),
	...
	@Update({ "update MOD_MODELOCOMUNICACION", "set NOMBRE = #{nombre,jdbcType=VARCHAR},",
			"ORDEN = #{orden,jdbcType=DECIMAL},", "IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL},",
			...
			"USUMODIFICACION = #{usumodificacion,jdbcType=DECIMAL},", "VISIBLE = #{visible,jdbcType=DECIMAL},",
			"PORDEFECTO = #{pordefecto,jdbcType=VARCHAR},",
			"IDPLANTILLAENVIOS = #{idplantillaenvios,jdbcType=DECIMAL},",
			"IDTIPOENVIOS = #{idtipoenvios,jdbcType=DECIMAL},", "GENERAREXCEL = #{generarexcel,jdbcType=DECIMAL}",
			"where IDMODELOCOMUNICACION = #{idmodelocomunicacion,jdbcType=DECIMAL}" })
