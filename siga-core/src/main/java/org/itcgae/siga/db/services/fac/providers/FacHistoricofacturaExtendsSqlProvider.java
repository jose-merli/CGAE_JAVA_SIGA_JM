...
public class FacHistoricofacturaExtendsSqlProvider extends FacHistoricofacturaSqlProvider {
	...
	public String getEstadosPagos(String idFactura, String idInstitucion, String idLenguaje) {
		...
		forward.SELECT_DISTINCT("CASE WHEN FT.IDTIPOACCION = 8 THEN FA.IDABONO WHEN FT.IDTIPOACCION = 9 THEN FA.IDABONO WHEN FT.IDTIPOACCION = 10 THEN FA.IDABONO END IDABONO");
		...
		forward.LEFT_OUTER_JOIN("FAC_ABONO FA ON ( FA.IDINSTITUCION = FH.IDINSTITUCION AND FA.IDABONO = FH.IDABONO )");
