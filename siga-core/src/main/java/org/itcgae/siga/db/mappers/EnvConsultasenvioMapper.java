...
public interface EnvConsultasenvioMapper {
	...
	@Insert({ "insert into ENV_CONSULTASENVIO (IDCONSULTAENVIO, IDENVIO, ", "IDOBJETIVO, IDINSTITUCION, ",
			...
			"IDPLANTILLADOCUMENTO, IDMODELOCOMUNICACION, ", "IDINFORME, SUFIJO, ", "CONSULTA)",
			...
			"#{idinforme,jdbcType=DECIMAL}, #{sufijo,jdbcType=VARCHAR}, ", "#{consulta,jdbcType=CLOB})" })
	...
	@Select({ "select", "IDCONSULTAENVIO, IDENVIO, IDOBJETIVO, IDINSTITUCION, IDCONSULTA, FECHABAJA, ",
			...
			"IDINFORME, SUFIJO, CONSULTA", "from ENV_CONSULTASENVIO",
