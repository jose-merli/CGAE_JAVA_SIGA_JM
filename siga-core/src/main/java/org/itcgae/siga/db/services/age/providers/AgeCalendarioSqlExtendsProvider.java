...
//				+ idLenguaje + "')");
	...
	public String getCalendarioEventos(Short idInstitucion, String perfiles, String idCalendario) {
		...
		sql.GROUP_BY("AGE.IDCALENDARIO, AGE.COLOR, EVENTO.IDEVENTO, EC.IDCURSO , EVENTO.FECHAINICIO, EVENTO.FECHAFIN, EVENTO.TITULO, EVENTO.LUGAR, EVENTO.DESCRIPCION, EVENTO.RECURSOS, EVENTO.IDTIPOEVENTO, EVENTO.IDESTADOEVENTO, EVENTO.IDINSTITUCION,"
