...
import org.itcgae.siga.db.entities.ScsSituacionExample.Criteria;
import org.itcgae.siga.db.entities.ScsSituacionExample.Criterion;
import org.itcgae.siga.db.entities.ScsSituacionExample;

public class ScsSituacionSqlProvider {
    /**
     ...
     */
    public String countByExample(ScsSituacionExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("SCS_SITUACION");
     ...
     * @mbg.generated Mon Jun 07 10:08:40 CEST 2021
     */
    public String deleteByExample(ScsSituacionExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("SCS_SITUACION");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Mon Jun 07 10:08:40 CEST 2021
     */
    public String insertSelective(ScsSituacion record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("SCS_SITUACION");
     ...
     * @mbg.generated Mon Jun 07 10:08:40 CEST 2021
     */
    public String selectByExample(ScsSituacionExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("IDSITUACION");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ScsSituacion record = (ScsSituacion) parameter.get("record");
        ScsSituacionExample example = (ScsSituacionExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("SCS_SITUACION");
     ...
     * @mbg.generated Mon Jun 07 10:08:40 CEST 2021
     */
    public String updateByPrimaryKeySelective(ScsSituacion record) {
        SQL sql = new SQL();
        sql.UPDATE("SCS_SITUACION");
        ...
        sql.WHERE("IDSITUACION = #{idsituacion,jdbcType=DECIMAL}");
     ...
     * @mbg.generated Mon Jun 07 10:08:40 CEST 2021
     */
    protected void applyWhere(SQL sql, ScsSituacionExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
