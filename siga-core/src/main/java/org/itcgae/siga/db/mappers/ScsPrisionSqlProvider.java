...
import org.itcgae.siga.db.entities.ScsPrisionExample.Criteria;
import org.itcgae.siga.db.entities.ScsPrisionExample.Criterion;
import org.itcgae.siga.db.entities.ScsPrisionExample;

public class ScsPrisionSqlProvider {
	 ...
	 */
	public String countByExample(ScsPrisionExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("SCS_PRISION");
	 ...
	 * @mbg.generated  Tue Oct 01 11:36:11 CEST 2019
	 */
	public String deleteByExample(ScsPrisionExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("SCS_PRISION");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Tue Oct 01 11:36:11 CEST 2019
	 */
	public String insertSelective(ScsPrision record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("SCS_PRISION");
	 ...
	 * @mbg.generated  Tue Oct 01 11:36:11 CEST 2019
	 */
	public String selectByExample(ScsPrisionExample example) {
		SQL sql = new SQL();
		if (example != null && example.isDistinct()) {
			sql.SELECT_DISTINCT("IDPRISION");
		} else {
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		ScsPrision record = (ScsPrision) parameter.get("record");
		ScsPrisionExample example = (ScsPrisionExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("SCS_PRISION");
		if (record.getIdprision() != null) {
	 ...
	 * @mbg.generated  Tue Oct 01 11:36:11 CEST 2019
	 */
	public String updateByPrimaryKeySelective(ScsPrision record) {
		SQL sql = new SQL();
		sql.UPDATE("SCS_PRISION");
		if (record.getNombre() != null) {
		...
		sql.WHERE("IDPRISION = #{idprision,jdbcType=DECIMAL}");
	 ...
	 * @mbg.generated  Tue Oct 01 11:36:11 CEST 2019
	 */
	protected void applyWhere(SQL sql, ScsPrisionExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
