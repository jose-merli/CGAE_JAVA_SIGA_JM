...
public interface EnvCamposplantillaMapper {
     ...
     */
    @Delete({
        "delete from ENV_CAMPOSPLANTILLA",
        "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
          ...
          "and IDCAMPO = #{idcampo,jdbcType=DECIMAL}",
     ...
     */
    @Insert({
        "insert into ENV_CAMPOSPLANTILLA (IDINSTITUCION, IDTIPOENVIOS, ",
        "IDPLANTILLAENVIOS, IDCAMPO, ",
        "TIPOCAMPO, FECHAMODIFICACION, ",
        "USUMODIFICACION, IDFORMATO, ",
        "VALOR)",
        ...
        "#{usumodificacion,jdbcType=DECIMAL}, #{idformato,jdbcType=DECIMAL}, ",
        "#{valor,jdbcType=CLOB})"
    })
    ...
    @Select({
        "select",
        "IDINSTITUCION, IDTIPOENVIOS, IDPLANTILLAENVIOS, IDCAMPO, TIPOCAMPO, FECHAMODIFICACION, ",
        "USUMODIFICACION, IDFORMATO, VALOR",
        "from ENV_CAMPOSPLANTILLA",
        "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
          "and IDTIPOENVIOS = #{idtipoenvios,jdbcType=DECIMAL}",
          "and IDPLANTILLAENVIOS = #{idplantillaenvios,jdbcType=DECIMAL}",
          "and IDCAMPO = #{idcampo,jdbcType=DECIMAL}",
    ...
    int updateByExampleSelective(@Param("record") EnvCamposplantilla record, @Param("example") EnvCamposplantillaExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") EnvCamposplantilla record, @Param("example") EnvCamposplantillaExample example);
    ...
    int updateByExample(@Param("record") EnvCamposplantilla record, @Param("example") EnvCamposplantillaExample example);
     ...
     */
    @Update({
        "update ENV_CAMPOSPLANTILLA",
        "set FECHAMODIFICACION = #{fechamodificacion,jdbcType=TIMESTAMP},",
          "USUMODIFICACION = #{usumodificacion,jdbcType=DECIMAL},",
          "IDFORMATO = #{idformato,jdbcType=DECIMAL},",
          "VALOR = #{valor,jdbcType=CLOB}",
        "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
          "and IDTIPOENVIOS = #{idtipoenvios,jdbcType=DECIMAL}",
          "and IDPLANTILLAENVIOS = #{idplantillaenvios,jdbcType=DECIMAL}",
          "and IDCAMPO = #{idcampo,jdbcType=DECIMAL}",
