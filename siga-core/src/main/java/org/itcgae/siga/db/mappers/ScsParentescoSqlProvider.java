...
import org.itcgae.siga.db.entities.ScsParentescoExample.Criteria;
import org.itcgae.siga.db.entities.ScsParentescoExample.Criterion;
import org.itcgae.siga.db.entities.ScsParentescoExample;

public class ScsParentescoSqlProvider {
	 ...
	 */
	public String countByExample(ScsParentescoExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("SCS_PARENTESCO");
	 ...
	 * @mbg.generated  Fri May 28 08:43:36 CEST 2021
	 */
	public String deleteByExample(ScsParentescoExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("SCS_PARENTESCO");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Fri May 28 08:43:36 CEST 2021
	 */
	public String insertSelective(ScsParentesco record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("SCS_PARENTESCO");
	 ...
	 * @mbg.generated  Fri May 28 08:43:36 CEST 2021
	 */
	public String selectByExample(ScsParentescoExample example) {
		SQL sql = new SQL();
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		ScsParentesco record = (ScsParentesco) parameter.get("record");
		ScsParentescoExample example = (ScsParentescoExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("SCS_PARENTESCO");
		if (record.getIdinstitucion() != null) {
	 ...
	 * @mbg.generated  Fri May 28 08:43:36 CEST 2021
	 */
	public String updateByPrimaryKeySelective(ScsParentesco record) {
		SQL sql = new SQL();
		sql.UPDATE("SCS_PARENTESCO");
		if (record.getFechamodificacion() != null) {
		...
		sql.WHERE("IDPARENTESCO = #{idparentesco,jdbcType=DECIMAL}");
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Fri May 28 08:43:36 CEST 2021
	 */
	protected void applyWhere(SQL sql, ScsParentescoExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
