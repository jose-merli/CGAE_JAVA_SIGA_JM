...
import org.itcgae.siga.db.entities.ForTiposervicioExample.Criteria;
import org.itcgae.siga.db.entities.ForTiposervicioExample.Criterion;

public class ForTiposervicioSqlProvider {
     ...
     */
    public String countByExample(ForTiposervicioExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("FOR_TIPOSERVICIO");
     ...
     * @mbg.generated Fri Dec 14 09:54:59 CET 2018
     */
    public String deleteByExample(ForTiposervicioExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("FOR_TIPOSERVICIO");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Fri Dec 14 09:54:59 CET 2018
     */
    public String insertSelective(ForTiposervicio record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("FOR_TIPOSERVICIO");
     ...
     * @mbg.generated Fri Dec 14 09:54:59 CET 2018
     */
    public String selectByExample(ForTiposervicioExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("IDTIPOSERVICIO");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ForTiposervicio record = (ForTiposervicio) parameter.get("record");
        ForTiposervicioExample example = (ForTiposervicioExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("FOR_TIPOSERVICIO");
     ...
     * @mbg.generated Fri Dec 14 09:54:59 CET 2018
     */
    public String updateByPrimaryKeySelective(ForTiposervicio record) {
        SQL sql = new SQL();
        sql.UPDATE("FOR_TIPOSERVICIO");
        ...
        sql.WHERE("IDTIPOSERVICIO = #{idtiposervicio,jdbcType=DECIMAL}");
     ...
     * @mbg.generated Fri Dec 14 09:54:59 CET 2018
     */
    protected void applyWhere(SQL sql, ForTiposervicioExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
