...
public interface EnvPlantillaremitentesMapper {
	 ...
	 * @mbg.generated  Tue Jan 22 10:10:11 CET 2019
	 */
	@Delete({ "delete from ENV_PLANTILLAREMITENTES", "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
	 ...
	 * @mbg.generated  Tue Jan 22 10:10:11 CET 2019
	 */
	@Insert({ "insert into ENV_PLANTILLAREMITENTES (IDINSTITUCION, IDTIPOENVIOS, ", "IDPLANTILLAENVIOS, IDPERSONA, ",
			"FECHAMODIFICACION, USUMODIFICACION, ", "CODIGOPOSTAL, CORREOELECTRONICO, ", "DOMICILIO, FAX1, ",
			"FAX2, IDPAIS, IDPOBLACION, ", "IDPROVINCIA, DESCRIPCION, ", "POBLACIONEXTRANJERA, MOVIL)",
	 ...
	 * @mbg.generated  Tue Jan 22 10:10:11 CET 2019
	 */
	@Select({ "select", "IDINSTITUCION, IDTIPOENVIOS, IDPLANTILLAENVIOS, IDPERSONA, FECHAMODIFICACION, ",
			"USUMODIFICACION, CODIGOPOSTAL, CORREOELECTRONICO, DOMICILIO, FAX1, FAX2, IDPAIS, ",
			"IDPOBLACION, IDPROVINCIA, DESCRIPCION, POBLACIONEXTRANJERA, MOVIL", "from ENV_PLANTILLAREMITENTES",
	...
	int updateByExampleSelective(@Param("record") EnvPlantillaremitentes record,
			@Param("example") EnvPlantillaremitentesExample example);
	...
	int updateByExample(@Param("record") EnvPlantillaremitentes record,
			@Param("example") EnvPlantillaremitentesExample example);
	 ...
	 * @mbg.generated  Tue Jan 22 10:10:11 CET 2019
	 */
	@Update({ "update ENV_PLANTILLAREMITENTES", "set FECHAMODIFICACION = #{fechamodificacion,jdbcType=TIMESTAMP},",
			"USUMODIFICACION = #{usumodificacion,jdbcType=DECIMAL},",
			"CODIGOPOSTAL = #{codigopostal,jdbcType=VARCHAR},",
			"CORREOELECTRONICO = #{correoelectronico,jdbcType=VARCHAR},", "DOMICILIO = #{domicilio,jdbcType=VARCHAR},",
			"FAX1 = #{fax1,jdbcType=VARCHAR},", "FAX2 = #{fax2,jdbcType=VARCHAR},",
			"IDPAIS = #{idpais,jdbcType=VARCHAR},", "IDPOBLACION = #{idpoblacion,jdbcType=VARCHAR},",
			"IDPROVINCIA = #{idprovincia,jdbcType=VARCHAR},", "DESCRIPCION = #{descripcion,jdbcType=VARCHAR},",
			"POBLACIONEXTRANJERA = #{poblacionextranjera,jdbcType=VARCHAR},", "MOVIL = #{movil,jdbcType=VARCHAR}",
			"where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
			"and IDTIPOENVIOS = #{idtipoenvios,jdbcType=DECIMAL}",
			"and IDPLANTILLAENVIOS = #{idplantillaenvios,jdbcType=DECIMAL}",
			"and IDPERSONA = #{idpersona,jdbcType=DECIMAL}" })
