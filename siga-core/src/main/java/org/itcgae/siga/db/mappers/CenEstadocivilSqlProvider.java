...
public class CenEstadocivilSqlProvider {
	 ...
	 */
	public String countByExample(CenEstadocivilExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("CEN_ESTADOCIVIL");
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String deleteByExample(CenEstadocivilExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("CEN_ESTADOCIVIL");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String insertSelective(CenEstadocivil record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("CEN_ESTADOCIVIL");
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String selectByExample(CenEstadocivilExample example) {
		SQL sql = new SQL();
		if (example != null && example.isDistinct()) {
			sql.SELECT_DISTINCT("IDESTADOCIVIL");
		} else {
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		CenEstadocivil record = (CenEstadocivil) parameter.get("record");
		CenEstadocivilExample example = (CenEstadocivilExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("CEN_ESTADOCIVIL");
		if (record.getIdestadocivil() != null) {
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String updateByPrimaryKeySelective(CenEstadocivil record) {
		SQL sql = new SQL();
		sql.UPDATE("CEN_ESTADOCIVIL");
		if (record.getDescripcion() != null) {
		...
		sql.WHERE("IDESTADOCIVIL = #{idestadocivil,jdbcType=DECIMAL}");
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	protected void applyWhere(SQL sql, CenEstadocivilExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
