...
public class FcsFacturacionJGSqlExtendsProvider extends FcsFacturacionjgSqlProvider {
    ...
    public String buscarFacturaciones(FacturacionItem facturacionItem, String idInstitucion, Integer tamMax) {
        ...
        sql2.FROM("FCS_FACTURACIONJG FAC LEFT JOIN FCS_FACT_GRUPOFACT_HITO ffgh ON (ffgh.IDFACTURACION = FAC.IDFACTURACION AND ffgh.IDINSTITUCION = FAC.IDINSTITUCION) LEFT JOIN SCS_GRUPOFACTURACION sg ON (sg.IDGRUPOFACTURACION = ffgh.IDGRUPOFACTURACION AND sg.IDINSTITUCION = ffgh.IDINSTITUCION) ");
        ...
        sql.GROUP_BY("IDINSTITUCION, ABREVIATURA, IDFACTURACION, FECHADESDE, FECHAHASTA, NOMBRE, IDGRUPOFACTURACION, REGULARIZACION, DESESTADO, IDESTADO, FECHAESTADO, IMPORTETOTAL,	IMPORTEPAGADO");
    ...
    public String historicoFacturacion(String idFacturacion, String lenguaje, String idInstitucion) {
        ...
        sql.SELECT(
        "(CASE WHEN AU.DESCRIPCION IS NOT NULL THEN AU.DESCRIPCION ELSE NULL END) AS USUARIO");
