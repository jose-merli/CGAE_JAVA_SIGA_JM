...
public class FacDisqueteabonosExtendsSqlProvider extends FacDisqueteabonosSqlProvider {
    ...
    public String getFicherosTransferencias(FicherosAbonosItem item, String idInstitucion, String idioma) {
        ...
        // Obtener por idDisqueteAbono
        if (!UtilidadesString.esCadenaVacia(item.getIdDisqueteAbono())) {
            principal.WHERE("c.iddisqueteabono = " + item.getIdDisqueteAbono());
        }
    ...
    public String getFacturasIncluidas(String idFichero, String idInstitucion, String idIdioma) {
        ...
        sql.SELECT("gr.DESCRIPCION ESTADO,"
                ...
                + "COUNT(1) NUMEROFACTURAS, SUM(ff2.IMPORTEABONADO) IMPORTETOTAL, SUM(ff.IMPPENDIENTEPORABONAR) PENDIENTETOTAL");
        ...
        sql.GROUP_BY("gr.DESCRIPCION, (CASE WHEN ff.IDCUENTA IS NOT NULL THEN F_SIGA_GETRECURSO(540020,"+idIdioma+") WHEN ff.IDCUENTA IS NULL THEN F_SIGA_GETRECURSO(540030,"+idIdioma+") END)");
