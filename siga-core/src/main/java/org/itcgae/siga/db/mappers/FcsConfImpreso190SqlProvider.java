...
import org.itcgae.siga.db.entities.FcsConfImpreso190Example.Criteria;
import org.itcgae.siga.db.entities.FcsConfImpreso190Example.Criterion;
import org.itcgae.siga.db.entities.FcsConfImpreso190Example;

public class FcsConfImpreso190SqlProvider {
    /**
     ...
     */
    public String countByExample(FcsConfImpreso190Example example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("FCS_CONF_IMPRESO190");
     ...
     * @mbg.generated Thu Nov 18 09:52:57 CET 2021
     */
    public String deleteByExample(FcsConfImpreso190Example example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("FCS_CONF_IMPRESO190");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Thu Nov 18 09:52:57 CET 2021
     */
    public String insertSelective(FcsConfImpreso190 record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("FCS_CONF_IMPRESO190");
     ...
     * @mbg.generated Thu Nov 18 09:52:57 CET 2021
     */
    public String selectByExample(FcsConfImpreso190Example example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        FcsConfImpreso190 record = (FcsConfImpreso190) parameter.get("record");
        FcsConfImpreso190Example example = (FcsConfImpreso190Example) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("FCS_CONF_IMPRESO190");
     ...
     * @mbg.generated Thu Nov 18 09:52:57 CET 2021
     */
    public String updateByPrimaryKeySelective(FcsConfImpreso190 record) {
        SQL sql = new SQL();
        sql.UPDATE("FCS_CONF_IMPRESO190");
     ...
     * @mbg.generated Thu Nov 18 09:52:57 CET 2021
     */
    protected void applyWhere(SQL sql, FcsConfImpreso190Example example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
