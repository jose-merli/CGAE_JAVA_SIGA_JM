...
public class ModPlantillaDocumentoConsultaExtendsSqlProvider {
	...
	public String selectConsultasByInforme(Short idInstitucion, Long idModeloComunicacion, Long idInforme,
		...
		sql.WHERE("plantilla.IDMODELOCOMUNICACION = " + idModeloComunicacion + " AND modelo.idinforme = " + idInforme
	...
	public String selectConsultaByIdConsulta(Short idInstitucion, Long idModeloComunicacion, Long idInforme,
		...
		sql.WHERE("consulta.idinstitucion = " + idInstitucion + " AND modelo.idmodelocomunicacion = "
				+ idModeloComunicacion + " AND modelo.idinforme = " + idInforme + " AND consulta.IDCONSULTA = "
				+ idConsulta);
