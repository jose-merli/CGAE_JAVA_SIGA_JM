...
public interface FacHistoricofacturaExtendsMapper extends FacHistoricofacturaMapper {
	...
	@Results({
			...
			@Result(column = "IMPTOTALPAGADO", property = "impTotalPagado", jdbcType = JdbcType.NUMERIC),
			@Result(column = "IMPTOTALPORPAGAR", property = "impTotalPorPagar", jdbcType = JdbcType.NUMERIC),
