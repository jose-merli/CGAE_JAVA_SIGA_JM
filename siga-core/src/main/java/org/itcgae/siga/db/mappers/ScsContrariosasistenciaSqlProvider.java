...
import org.itcgae.siga.db.entities.ScsContrariosasistenciaExample.Criteria;
import org.itcgae.siga.db.entities.ScsContrariosasistenciaExample.Criterion;
import org.itcgae.siga.db.entities.ScsContrariosasistenciaExample;

public class ScsContrariosasistenciaSqlProvider {
    /**
     ...
     */
    public String countByExample(ScsContrariosasistenciaExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("SCS_CONTRARIOSASISTENCIA");
     ...
     * @mbg.generated Mon Aug 02 09:35:21 CEST 2021
     */
    public String deleteByExample(ScsContrariosasistenciaExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("SCS_CONTRARIOSASISTENCIA");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Mon Aug 02 09:35:21 CEST 2021
     */
    public String insertSelective(ScsContrariosasistencia record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("SCS_CONTRARIOSASISTENCIA");
     ...
     * @mbg.generated Mon Aug 02 09:35:21 CEST 2021
     */
    public String selectByExample(ScsContrariosasistenciaExample example) {
        SQL sql = new SQL();
        ...
        sql.FROM("SCS_CONTRARIOSASISTENCIA");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ScsContrariosasistencia record = (ScsContrariosasistencia) parameter.get("record");
        ScsContrariosasistenciaExample example = (ScsContrariosasistenciaExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("SCS_CONTRARIOSASISTENCIA");
     ...
     * @mbg.generated Mon Aug 02 09:35:21 CEST 2021
     */
    public String updateByPrimaryKeySelective(ScsContrariosasistencia record) {
        SQL sql = new SQL();
        sql.UPDATE("SCS_CONTRARIOSASISTENCIA");
     ...
     * @mbg.generated Mon Aug 02 09:35:21 CEST 2021
     */
    protected void applyWhere(SQL sql, ScsContrariosasistenciaExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
