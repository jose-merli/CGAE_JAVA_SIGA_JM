...
public class AgeTiponotificacioneventoSqlProvider {
     ...
     */
    public String countByExample(AgeTiponotificacioneventoExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("AGE_TIPONOTIFICACIONEVENTO");
     ...
     * @mbg.generated Thu Oct 18 17:49:37 CEST 2018
     */
    public String deleteByExample(AgeTiponotificacioneventoExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("AGE_TIPONOTIFICACIONEVENTO");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Thu Oct 18 17:49:37 CEST 2018
     */
    public String insertSelective(AgeTiponotificacionevento record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("AGE_TIPONOTIFICACIONEVENTO");
     ...
     * @mbg.generated Thu Oct 18 17:49:37 CEST 2018
     */
    public String selectByExample(AgeTiponotificacioneventoExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        AgeTiponotificacionevento record = (AgeTiponotificacionevento) parameter.get("record");
        AgeTiponotificacioneventoExample example = (AgeTiponotificacioneventoExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("AGE_TIPONOTIFICACIONEVENTO");
     ...
     * @mbg.generated Thu Oct 18 17:49:37 CEST 2018
     */
    public String updateByPrimaryKeySelective(AgeTiponotificacionevento record) {
        SQL sql = new SQL();
        sql.UPDATE("AGE_TIPONOTIFICACIONEVENTO");
        ...
        sql.WHERE("IDTIPONOTIFICACIONEVENTO = #{idtiponotificacionevento,jdbcType=DECIMAL}");
     ...
     * @mbg.generated Thu Oct 18 17:49:37 CEST 2018
     */
    protected void applyWhere(SQL sql, AgeTiponotificacioneventoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
