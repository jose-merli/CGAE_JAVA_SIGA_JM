...
import org.itcgae.siga.db.entities.PysProductosExample.Criteria;
import org.itcgae.siga.db.entities.PysProductosExample.Criterion;
import org.itcgae.siga.db.entities.PysProductosExample;

public class PysProductosSqlProvider {
	 ...
	 */
	public String countByExample(PysProductosExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("PYS_PRODUCTOS");
	 ...
	 * @mbg.generated  Wed Jun 16 14:57:12 CEST 2021
	 */
	public String deleteByExample(PysProductosExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("PYS_PRODUCTOS");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Jun 16 14:57:12 CEST 2021
	 */
	public String insertSelective(PysProductos record) {
		SQL sql = new SQL();
	 ...
	 * @mbg.generated  Wed Jun 16 14:57:12 CEST 2021
	 */
	public String selectByExample(PysProductosExample example) {
		SQL sql = new SQL();
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		PysProductos record = (PysProductos) parameter.get("record");
		PysProductosExample example = (PysProductosExample) parameter.get("example");
		SQL sql = new SQL();
	 ...
	 * @mbg.generated  Wed Jun 16 14:57:12 CEST 2021
	 */
	public String updateByPrimaryKeySelective(PysProductos record) {
		SQL sql = new SQL();
		sql.UPDATE("PYS_PRODUCTOS");
		if (record.getDescripcion() != null) {
	 ...
	 * @mbg.generated  Wed Jun 16 14:57:12 CEST 2021
	 */
	protected void applyWhere(SQL sql, PysProductosExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
