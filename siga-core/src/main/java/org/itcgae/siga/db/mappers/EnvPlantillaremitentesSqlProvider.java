...
import org.itcgae.siga.db.entities.EnvPlantillaremitentesExample.Criteria;
import org.itcgae.siga.db.entities.EnvPlantillaremitentesExample.Criterion;

public class EnvPlantillaremitentesSqlProvider {
	 ...
	 */
	public String countByExample(EnvPlantillaremitentesExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("ENV_PLANTILLAREMITENTES");
	 ...
	 * @mbg.generated  Tue Jan 22 10:10:11 CET 2019
	 */
	public String deleteByExample(EnvPlantillaremitentesExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("ENV_PLANTILLAREMITENTES");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Tue Jan 22 10:10:11 CET 2019
	 */
	public String insertSelective(EnvPlantillaremitentes record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("ENV_PLANTILLAREMITENTES");
	 ...
	 * @mbg.generated  Tue Jan 22 10:10:11 CET 2019
	 */
	public String selectByExample(EnvPlantillaremitentesExample example) {
		SQL sql = new SQL();
		...
		sql.SELECT("MOVIL");
		sql.FROM("ENV_PLANTILLAREMITENTES");
		applyWhere(sql, example, false);
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		EnvPlantillaremitentes record = (EnvPlantillaremitentes) parameter.get("record");
		EnvPlantillaremitentesExample example = (EnvPlantillaremitentesExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("ENV_PLANTILLAREMITENTES");
		if (record.getIdinstitucion() != null) {
	 ...
	 * @mbg.generated  Tue Jan 22 10:10:11 CET 2019
	 */
	public String updateByPrimaryKeySelective(EnvPlantillaremitentes record) {
		SQL sql = new SQL();
		sql.UPDATE("ENV_PLANTILLAREMITENTES");
		if (record.getFechamodificacion() != null) {
	 ...
	 * @mbg.generated  Tue Jan 22 10:10:11 CET 2019
	 */
	protected void applyWhere(SQL sql, EnvPlantillaremitentesExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
