...
public interface EnvHistoricoestadoenvioMapper {
     ...
     */
    @Delete({
        "delete from ENV_HISTORICOESTADOENVIO",
     ...
     */
    @Insert({
        "insert into ENV_HISTORICOESTADOENVIO (IDINSTITUCION, IDENVIO, ",
        "IDHISTORICO, IDESTADO, ",
        "FECHAESTADO, FECHAMODIFICACION, ",
        "USUMODIFICACION)",
    ...
    @SelectKey(statement="SELECT SEQ_ENV_HISTORICOESTADOENVIO.NEXTVAL FROM DUAL", keyProperty="idestado", before=true, resultType=Short.class)
    ...
    @Select({
        "select",
        "IDINSTITUCION, IDENVIO, IDHISTORICO, IDESTADO, FECHAESTADO, FECHAMODIFICACION, ",
        "USUMODIFICACION",
        "from ENV_HISTORICOESTADOENVIO",
        "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
          "and IDENVIO = #{idenvio,jdbcType=DECIMAL}",
          "and IDHISTORICO = #{idhistorico,jdbcType=DECIMAL}"
    })
    ...
    int updateByExampleSelective(@Param("record") EnvHistoricoestadoenvio record, @Param("example") EnvHistoricoestadoenvioExample example);
    ...
    int updateByExample(@Param("record") EnvHistoricoestadoenvio record, @Param("example") EnvHistoricoestadoenvioExample example);
     ...
     */
    @Update({
        "update ENV_HISTORICOESTADOENVIO",
        "set IDESTADO = #{idestado,jdbcType=DECIMAL},",
