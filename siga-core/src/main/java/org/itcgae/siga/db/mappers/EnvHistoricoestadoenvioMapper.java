...
public interface EnvHistoricoestadoenvioMapper {
	...
	@SelectKey(statement = "SELECT MAX(IDHISTORICO) + 1 from ENV_HISTORICOESTADOENVIO where IDINSTITUCION = #{idinstitucion} AND IDENVIO = #{idenvio}", keyProperty = "idhistorico", before = true, resultType = Integer.class)
