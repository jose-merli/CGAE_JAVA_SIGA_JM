...
public class EnvPlantillasenviosSqlProvider {
	 ...
	 * @mbg.generated  Mon Oct 22 11:26:21 CEST 2018
	 */
	public String insertSelective(EnvPlantillasenvios record) {
		SQL sql = new SQL();
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		EnvPlantillasenvios record = (EnvPlantillasenvios) parameter.get("record");
	 ...
	 * @mbg.generated  Mon Oct 22 11:26:21 CEST 2018
	 */
	public String updateByPrimaryKeySelective(EnvPlantillasenvios record) {
		SQL sql = new SQL();
		sql.UPDATE("ENV_PLANTILLASENVIOS");
		if (record.getNombre() != null) {
