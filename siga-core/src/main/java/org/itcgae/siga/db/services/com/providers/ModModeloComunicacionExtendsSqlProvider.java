...
public class ModModeloComunicacionExtendsSqlProvider {
	...
	public String selectPlantillaModelo(String idModeloComunicacion, Short idInstitucion){
		...
		sql.JOIN("ENV_PLANTILLASENVIOS PLANTILLA ON PLANTILLA.IDPLANTILLAENVIOS = MPLANTILLA.IDPLANTILLAENVIOS AND MPLANTILLA.IDINSTITUCION = PLANTILLA.IDINSTITUCION AND MPLANTILLA.IDTIPOENVIOS = PLANTILLA.IDTIPOENVIOS");
