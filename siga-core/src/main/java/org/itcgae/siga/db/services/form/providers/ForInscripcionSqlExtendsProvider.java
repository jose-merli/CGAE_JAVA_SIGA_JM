...
public class ForInscripcionSqlExtendsProvider extends ForInscripcionSqlProvider {
	...
	public String selectInscripciones(InscripcionItem inscripcionItem, String idLenguaje) {
		...
		sql.SELECT("CONCAT(CONCAT(PERSONA.APELLIDOS1 || ' ',PERSONA.APELLIDOS2),', ' || PERSONA.NOMBRE) AS NOMBRE");
		sql.SELECT("PERSONA.NIFCIF AS IDENTIFICACION");
		...
		sql.INNER_JOIN("CEN_PERSONA PERSONA ON (PERSONA.IDPERSONA = INSC.IDPERSONA  )");
		sql.INNER_JOIN(
		...
		sql.LEFT_OUTER_JOIN(
				"FOR_PERSONA_CURSO PERCURSO2 ON PERCURSO2.IDCURSO = CURSO.IDCURSO AND CURSO.IDINSTITUCION = PERCURSO2.IDINSTITUCION");
		sql.LEFT_OUTER_JOIN(
		...
		sql.GROUP_BY("INSC.IDINSCRIPCION, INSC.IDESTADOINSCRIPCION, MINPRECIO.PRECIODESDE ,INSC.IDFORMAPAGO, MAXPRECIO.PRECIOHASTA, INSC.IDPERSONA, INSC.EMITIRCERTIFICADO, INSC.CERTIFICADOEMITIDO,CURSO.IDESTADOCURSO, CURSO.IDCURSO, INSC.IDINSTITUCION, CURSO.CODIGOCURSO, CURSO.NOMBRECURSO, CAT.DESCRIPCION, CONCAT(CURSO.PRECIODESDE|| ' - ', CURSO.PRECIOHASTA), TO_CHAR(CURSO.FECHAIMPARTICIONDESDE,'DD/MM/YYYY'), TO_CHAR(CURSO.FECHAIMPARTICIONHASTA,'DD/MM/YYYY'), TO_CHAR(INSC.FECHASOLICITUD,'DD/MM/YYYY'), CAT2.DESCRIPCION, INSC.CALIFICACION,INSC.IDCALIFICACION, INSC.IDPETICIONSUSCRIPCION, CURSO.MINIMOASISTENCIA,PERSONA.NOMBRE,PERSONA.NIFCIF, CONCAT(PERSONA.APELLIDOS1 || ' ',PERSONA.APELLIDOS2)");
	...
	public String selectInscripcionByPrimaryKey(InscripcionItem inscripcionItem) {
		...
		sql.GROUP_BY("INSC.IDINSCRIPCION, INSC.IDESTADOINSCRIPCION, INSC.IDPERSONA,INSC.IDFORMAPAGO, INSC.EMITIRCERTIFICADO, INSC.CERTIFICADOEMITIDO,CURSO.IDESTADOCURSO, CURSO.IDCURSO, INSC.IDINSTITUCION, CURSO.CODIGOCURSO, CURSO.NOMBRECURSO, CAT.DESCRIPCION, CONCAT(CURSO.PRECIODESDE|| ' - ', CURSO.PRECIOHASTA), TO_CHAR(CURSO.FECHAIMPARTICIONDESDE,'DD/MM/YYYY'), TO_CHAR(CURSO.FECHAIMPARTICIONHASTA,'DD/MM/YYYY'), TO_CHAR(INSC.FECHASOLICITUD,'DD/MM/YYYY'), CAT2.DESCRIPCION, INSC.CALIFICACION, INSC.IDPETICIONSUSCRIPCION, CURSO.MINIMOASISTENCIA,PERSONA.NOMBRE,PERSONA.NIFCIF, CONCAT(PERSONA.APELLIDOS1 || ' ',PERSONA.APELLIDOS2)");
