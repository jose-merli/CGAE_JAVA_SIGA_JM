...
public class ForInscripcionSqlExtendsProvider extends ForInscripcionSqlProvider {
	...
	public String selectInscripciones(InscripcionItem inscripcionItem, String idLenguaje) {
		...
		sql3.INNER_JOIN("PYS_PERIODICIDAD per on per.IDPERIODICIDAD = pys.IDPERIODICIDAD where pys.idInstitucion = '" + inscripcionItem.getIdInstitucion() + "' GROUP BY SERVICIOINST.DESCRIPCION");
		...
		sql4.INNER_JOIN("PYS_PRECIOSSERVICIOS PYS ON PYS.IDSERVICIO = SERVICIO.IDSERVICIO AND SERVICIO.IDTIPOSERVICIOS = PYS.IDTIPOSERVICIOS  "
				+ "AND PYS.IDSERVICIOSINSTITUCION = SERVICIOINST.IDSERVICIOSINSTITUCION");
		sql4.INNER_JOIN("PYS_PERIODICIDAD per on per.IDPERIODICIDAD = pys.IDPERIODICIDAD where pys.idInstitucion = '" + inscripcionItem.getIdInstitucion() + "' GROUP BY SERVICIOINST.DESCRIPCION");
	...
	public String searchCourseByIdcurso(String idCurso, Short idInstitucion) {
		...
		sql.GROUP_BY("CURSO.IDCURSO, CURSO.CODIGOCURSO, CURSO.NOMBRECURSO, CURSO.IDINSTITUCION, CURSO.IDESTADOCURSO, \r\n" + 
				"CURSO.IDVISIBILIDADCURSO, TO_CHAR(CURSO.DESCRIPCION), CAT.DESCRIPCION, CURSO.IDINSTITUCION, \r\n" + 
				"CAT1.DESCRIPCION, INSTITUCION.ABREVIATURA, CURSO.PRECIODESDE, CURSO.PRECIOHASTA, CURSO.FECHAINSCRIPCIONDESDE, CURSO.FECHAINSCRIPCIONHASTA, CURSO.FECHAINSCRIPCIONDESDE, \r\n" + 
				"CURSO.FECHAINSCRIPCIONHASTA, CURSO.FECHAIMPARTICIONDESDE, CURSO.FECHAIMPARTICIONHASTA, \r\n" + 
				"CURSO.FECHAIMPARTICIONDESDE, CURSO.FECHAIMPARTICIONHASTA,\r\n" + 
				"CURSO.FLAGARCHIVADO, CURSO.LUGAR, CURSO.NUMEROPLAZAS, CURSO.AUTOVALIDACIONINSCRIPCION, CURSO.MINIMOASISTENCIA");
