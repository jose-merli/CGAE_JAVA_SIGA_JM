...
public interface FacFacturaMapper {
     ...
     */
    @Insert({
        "insert into FAC_FACTURA (IDINSTITUCION, IDFACTURA, ",
        "FECHAEMISION, CONTABILIZADA, ",
        "IDSERIEFACTURACION, IDPROGRAMACION, ",
        "IDFORMAPAGO, IDPERSONA, ",
        "FECHAMODIFICACION, USUMODIFICACION, ",
        "NUMEROFACTURA, OBSERVACIONES, ",
        "IDCUENTA, IDPERSONADEUDOR, ",
        "IDCUENTADEUDOR, CTACLIENTE, ",
        "OBSERVINFORME, IMPTOTAL, ",
        "IMPTOTALIVA, IMPTOTALNETO, ",
        "IMPTOTALANTICIPADO, IMPTOTALPAGADOPORCAJA, ",
        "IMPTOTALPAGADOSOLOCAJA, IMPTOTALPAGADOSOLOTARJETA, ",
        "IMPTOTALPAGADOPORBANCO, IMPTOTALPAGADO, ",
        "IMPTOTALPORPAGAR, IMPTOTALCOMPENSADO, ",
        "ESTADO, REFMANDATOSEPA, ",
        "IDMANDATO, COMISIONIDFACTURA, ",
        "TRASPASADA, ERRORTRASPASO, ",
        "ENVIOTRASPASO)",
    ...
    @Select({
        "select",
        "IDINSTITUCION, IDFACTURA, FECHAEMISION, CONTABILIZADA, IDSERIEFACTURACION, IDPROGRAMACION, ",
    ...
    @Update({
        "update FAC_FACTURA",
        "set FECHAEMISION = #{fechaemision,jdbcType=TIMESTAMP},",
          ...
          "NUMEROFACTURA = #{numerofactura,jdbcType=VARCHAR},",
          ...
          "CTACLIENTE = #{ctacliente,jdbcType=VARCHAR},",
          "OBSERVINFORME = #{observinforme,jdbcType=VARCHAR},",
          ...
          "REFMANDATOSEPA = #{refmandatosepa,jdbcType=VARCHAR},",
          "IDMANDATO = #{idmandato,jdbcType=DECIMAL},",
          "COMISIONIDFACTURA = #{comisionidfactura,jdbcType=VARCHAR},",
          "TRASPASADA = #{traspasada,jdbcType=VARCHAR},",
          "ERRORTRASPASO = #{errortraspaso,jdbcType=VARCHAR},",
