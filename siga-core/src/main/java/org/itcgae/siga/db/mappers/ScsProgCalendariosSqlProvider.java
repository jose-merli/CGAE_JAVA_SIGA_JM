...
public class ScsProgCalendariosSqlProvider {
	...
	public String insertSelective(ScsProgCalendarios record) {
		...
		if (record.getProcesandogeneracion() != null) {
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		...
		if (record.getIdconjuntoguardia() != null) {
			sql.SET("IDCONJUNTOGUARDIA = #{record.idconjuntoguardia,jdbcType=NUMERIC}");
		}
		if (record.getIdinstitucion() != null) {
		...
		if (record.getEstado() != null) {
			sql.SET("ESTADO = #{record.estado,jdbcType=NUMERIC}");
		}
		if (record.getFechamodificacion() != null) {
		...
		if (record.getIdficherocalendario() != null) {
			sql.SET("IDFICHEROCALENDARIO = #{record.idficherocalendario,jdbcType=NUMERIC}");
		}
		if (record.getObservaciones() != null) {
			sql.SET("OBSERVACIONES = #{record.observaciones,jdbcType=VARCHAR}");
		}
		if (record.getProcesandogeneracion() != null) {
			sql.SET("PROCESANDOGENERACION = #{record.procesandogeneracion,jdbcType=NUMERIC}");
		}
