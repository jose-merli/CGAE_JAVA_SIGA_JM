...
public class CenTratamientoSqlProvider {
	 ...
	 */
	public String countByExample(CenTratamientoExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("CEN_TRATAMIENTO");
	 ...
	 * @mbg.generated  Wed Nov 10 17:50:15 CET 2021
	 */
	public String deleteByExample(CenTratamientoExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("CEN_TRATAMIENTO");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Nov 10 17:50:15 CET 2021
	 */
	public String insertSelective(CenTratamiento record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("CEN_TRATAMIENTO");
		...
		if (record.getGenero() != null) {
			sql.VALUES("GENERO", "#{genero,jdbcType=VARCHAR}");
		}
	 ...
	 * @mbg.generated  Wed Nov 10 17:50:15 CET 2021
	 */
	public String selectByExample(CenTratamientoExample example) {
		SQL sql = new SQL();
		if (example != null && example.isDistinct()) {
			sql.SELECT_DISTINCT("IDTRATAMIENTO");
		} else {
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		CenTratamiento record = (CenTratamiento) parameter.get("record");
		CenTratamientoExample example = (CenTratamientoExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("CEN_TRATAMIENTO");
		if (record.getIdtratamiento() != null) {
		...
		if (record.getGenero() != null) {
			sql.SET("GENERO = #{record.genero,jdbcType=VARCHAR}");
		}
		if (record.getObservaciones() != null) {
	 ...
	 * @mbg.generated  Wed Nov 10 17:50:15 CET 2021
	 */
	public String updateByPrimaryKeySelective(CenTratamiento record) {
		SQL sql = new SQL();
		sql.UPDATE("CEN_TRATAMIENTO");
		if (record.getFechamodificacion() != null) {
		...
		if (record.getGenero() != null) {
			sql.SET("GENERO = #{genero,jdbcType=VARCHAR}");
		}
		if (record.getObservaciones() != null) {
			sql.SET("OBSERVACIONES = #{observaciones,jdbcType=VARCHAR}");
		}
		sql.WHERE("IDTRATAMIENTO = #{idtratamiento,jdbcType=DECIMAL}");
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Nov 10 17:50:15 CET 2021
	 */
	protected void applyWhere(SQL sql, CenTratamientoExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
