...
public class AdmUsuariosSqlProvider {
	 ...
	 */
	public String countByExample(AdmUsuariosExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("ADM_USUARIOS");
	 ...
	 * @mbg.generated  Wed Mar 18 07:37:06 CET 2020
	 */
	public String deleteByExample(AdmUsuariosExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("ADM_USUARIOS");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Mar 18 07:37:06 CET 2020
	 */
	public String insertSelective(AdmUsuarios record) {
		SQL sql = new SQL();
		...
		if (record.getUltimaConexion() != null) {
			sql.VALUES("ULTIMA_CONEXION", "#{ultimaConexion,jdbcType=TIMESTAMP}");
		}
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Mar 18 07:37:06 CET 2020
	 */
	public String selectByExample(AdmUsuariosExample example) {
		SQL sql = new SQL();
		...
		sql.SELECT("ULTIMA_CONEXION");
		sql.FROM("ADM_USUARIOS");
		applyWhere(sql, example, false);
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		AdmUsuarios record = (AdmUsuarios) parameter.get("record");
		AdmUsuariosExample example = (AdmUsuariosExample) parameter.get("example");
		SQL sql = new SQL();
		...
		if (record.getUltimaConexion() != null) {
			sql.SET("ULTIMA_CONEXION = #{record.ultimaConexion,jdbcType=TIMESTAMP}");
		}
	 ...
	 * @mbg.generated  Wed Mar 18 07:37:06 CET 2020
	 */
	public String updateByPrimaryKeySelective(AdmUsuarios record) {
		SQL sql = new SQL();
		sql.UPDATE("ADM_USUARIOS");
		if (record.getDescripcion() != null) {
		...
		if (record.getUltimaConexion() != null) {
			sql.SET("ULTIMA_CONEXION = #{ultimaConexion,jdbcType=TIMESTAMP}");
		}
	 ...
	 * @mbg.generated  Wed Mar 18 07:37:06 CET 2020
	 */
	protected void applyWhere(SQL sql, AdmUsuariosExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
