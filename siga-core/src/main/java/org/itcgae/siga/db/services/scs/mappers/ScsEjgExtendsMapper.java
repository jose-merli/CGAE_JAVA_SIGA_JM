...
public interface ScsEjgExtendsMapper extends ScsEjgMapper {
	...
	@Results({
			...
			@Result(column = "idpersonajg", property = "idPersonajg", jdbcType = JdbcType.INTEGER),
	...
	@Results({
			...
			@Result(column = "nig", property = "nig", jdbcType = JdbcType.VARCHAR),
			@Result(column = "delitosSeleccionados", property = "delitosSeleccionados", jdbcType = JdbcType.VARCHAR),
	...
	@Results({ @Result(column = "SJCS", property = "sjcs", jdbcType = JdbcType.VARCHAR),
			...
			@Result(column = "art27", property = "art27", jdbcType = JdbcType.BOOLEAN),
	})
