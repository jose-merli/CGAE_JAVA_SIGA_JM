...
List<AsuntosClaveJusticiableItem> searchClaveAsuntosEJG(AsuntosJusticiableItem asuntosJusticiableItem, Integer tamMaximo);
	...
	@Results({ 
		...
		@Result(column = "anioexpediente", property = "annio", jdbcType = JdbcType.VARCHAR),
		@Result(column = "numeroexpediente", property = "numEJG", jdbcType = JdbcType.VARCHAR),
		@Result(column = "idtipoexpediente", property = "tipoEJG", jdbcType = JdbcType.VARCHAR),
	...
	@Results({ 
		@Result(column = "idGuardia", property = "tieneGuardia", jdbcType = JdbcType.VARCHAR),})
	...
	@Results({ 
		@Result(column = "idTurno", property = "tieneTurno", jdbcType = JdbcType.VARCHAR),
		@Result(column = "idPersona", property = "idPersona", jdbcType = JdbcType.VARCHAR),})
