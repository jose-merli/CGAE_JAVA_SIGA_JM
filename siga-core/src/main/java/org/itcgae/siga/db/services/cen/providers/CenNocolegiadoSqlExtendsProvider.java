...
//		}
    ...
    public String selectRetencionesColegialYSociedades(PersonaSearchDTO personaSearchDto, String idLenguaje, String idInstitucion) {
        return "(" + selectRetenciones(personaSearchDto, idLenguaje, idInstitucion) + ") UNION (" + selectRetencionesColegial(personaSearchDto, idLenguaje, idInstitucion) + ")";
    }
