...
public interface EnvPlantillasenviosMapper {
	...
	@Insert({ "insert into ENV_PLANTILLASENVIOS (IDINSTITUCION, IDTIPOENVIOS, ", "IDPLANTILLAENVIOS, NOMBRE, ",
			"FECHAMODIFICACION, USUMODIFICACION, ", "ACUSERECIBO, FECHABAJA, ", "IDDIRECCION, IDPERSONA, ",
			"DESCRIPCION, ANTIGUA, ", "ASUNTO, CUERPO)",
	...
	@Select({ "select", "IDINSTITUCION, IDTIPOENVIOS, IDPLANTILLAENVIOS, NOMBRE, FECHAMODIFICACION, USUMODIFICACION, ",
			"ACUSERECIBO, FECHABAJA, IDDIRECCION, IDPERSONA, DESCRIPCION, ANTIGUA, ASUNTO, ", "CUERPO",
			"from ENV_PLANTILLASENVIOS", "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
			"and IDTIPOENVIOS = #{idtipoenvios,jdbcType=DECIMAL}",
			"and IDPLANTILLAENVIOS = #{idplantillaenvios,jdbcType=DECIMAL}" })
	@Results({ @Result(column = "IDINSTITUCION", property = "idinstitucion", jdbcType = JdbcType.DECIMAL, id = true),
			@Result(column = "IDTIPOENVIOS", property = "idtipoenvios", jdbcType = JdbcType.DECIMAL, id = true),
	...
	int updateByExampleSelective(@Param("record") EnvPlantillasenviosWithBLOBs record,
	...
	int updateByExampleWithBLOBs(@Param("record") EnvPlantillasenviosWithBLOBs record,
			@Param("example") EnvPlantillasenviosExample example);
	...
	@Update({ "update ENV_PLANTILLASENVIOS", "set NOMBRE = #{nombre,jdbcType=VARCHAR},",
			...
			"FECHABAJA = #{fechabaja,jdbcType=TIMESTAMP},", "IDDIRECCION = #{iddireccion,jdbcType=DECIMAL},",
			"IDPERSONA = #{idpersona,jdbcType=DECIMAL},", "DESCRIPCION = #{descripcion,jdbcType=VARCHAR},",
			"ANTIGUA = #{antigua,jdbcType=VARCHAR},", "ASUNTO = #{asunto,jdbcType=CLOB},",
			"CUERPO = #{cuerpo,jdbcType=CLOB}", "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
			"and IDTIPOENVIOS = #{idtipoenvios,jdbcType=DECIMAL}",
			"and IDPLANTILLAENVIOS = #{idplantillaenvios,jdbcType=DECIMAL}" })
	...
	@Update({ "update ENV_PLANTILLASENVIOS", "set NOMBRE = #{nombre,jdbcType=VARCHAR},",
			...
			"FECHABAJA = #{fechabaja,jdbcType=TIMESTAMP},", "IDDIRECCION = #{iddireccion,jdbcType=DECIMAL},",
			"IDPERSONA = #{idpersona,jdbcType=DECIMAL},", "DESCRIPCION = #{descripcion,jdbcType=VARCHAR},",
			"ANTIGUA = #{antigua,jdbcType=VARCHAR}", "where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
			"and IDTIPOENVIOS = #{idtipoenvios,jdbcType=DECIMAL}",
			"and IDPLANTILLAENVIOS = #{idplantillaenvios,jdbcType=DECIMAL}" })
