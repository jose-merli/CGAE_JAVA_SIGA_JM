...
public interface EnvPlantillasenviosMapper {
	...
	@Insert({ "insert into ENV_PLANTILLASENVIOS (IDINSTITUCION, IDTIPOENVIOS, ", "IDPLANTILLAENVIOS, NOMBRE, ",
			...
			"#{descripcion,jdbcType=VARCHAR}, #{asunto,jdbcType=CLOB}, ", "#{cuerpo,jdbcType=CLOB})" })
	...
	@Select({ "select", "IDINSTITUCION, IDTIPOENVIOS, IDPLANTILLAENVIOS, NOMBRE, FECHAMODIFICACION, USUMODIFICACION, ",
			"ACUSERECIBO, FECHABAJA, IDDIRECCION, IDPERSONA, DESCRIPCION, ASUNTO, CUERPO", "from ENV_PLANTILLASENVIOS",
	...
	@Update({ "update ENV_PLANTILLASENVIOS", "set NOMBRE = #{nombre,jdbcType=VARCHAR},",
			...
			"ASUNTO = #{asunto,jdbcType=CLOB},", "CUERPO = #{cuerpo,jdbcType=CLOB}",
			"where IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL}",
			"and IDTIPOENVIOS = #{idtipoenvios,jdbcType=DECIMAL}",
			"and IDPLANTILLAENVIOS = #{idplantillaenvios,jdbcType=DECIMAL}" })
