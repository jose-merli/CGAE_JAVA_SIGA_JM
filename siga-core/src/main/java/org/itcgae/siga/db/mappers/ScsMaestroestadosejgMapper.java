...
public interface ScsMaestroestadosejgMapper {
     ...
     */
    @Delete({
        "delete from SCS_MAESTROESTADOSEJG",
     ...
     */
    @Insert({
        "insert into SCS_MAESTROESTADOSEJG (IDESTADOEJG, DESCRIPCION, ",
        "FECHAMODIFICACION, USUMODIFICACION, ",
        "CODIGOEXT, BLOQUEADO, ",
        "ORDEN, VISIBLECOMISION, ",
    ...
    @Results({
        @Result(column="IDESTADOEJG", property="idestadoejg", jdbcType=JdbcType.DECIMAL, id=true),
    ...
    @Select({
        "select",
        "IDESTADOEJG, DESCRIPCION, FECHAMODIFICACION, USUMODIFICACION, CODIGOEXT, BLOQUEADO, ",
        "ORDEN, VISIBLECOMISION, CODIGOEJIS, FECHA_BAJA",
        "from SCS_MAESTROESTADOSEJG",
        "where IDESTADOEJG = #{idestadoejg,jdbcType=DECIMAL}"
    })
    @Results({
        @Result(column="IDESTADOEJG", property="idestadoejg", jdbcType=JdbcType.DECIMAL, id=true),
    ...
    int updateByExampleSelective(@Param("record") ScsMaestroestadosejg record, @Param("example") ScsMaestroestadosejgExample example);
    ...
    int updateByExample(@Param("record") ScsMaestroestadosejg record, @Param("example") ScsMaestroestadosejgExample example);
    ...
    @Update({
        ...
        "set DESCRIPCION = #{descripcion,jdbcType=VARCHAR},",
          ...
          "VISIBLECOMISION = #{visiblecomision,jdbcType=VARCHAR},",
