...
public interface ForPersonaCursoMapper {
     ...
     */
    @Insert({
        "insert into FOR_PERSONA_CURSO (IDPERSONA, IDCURSO, ",
        "IDROL, USUMODIFICACION, ",
    ...
    @Select({
        "select",
        "IDPERSONA, IDCURSO, IDROL, USUMODIFICACION, FECHAMODIFICACION, IDINSTITUCION, ",
        "IDTIPOCOSTE, TARIFA, TUTOR",
        "from FOR_PERSONA_CURSO",
        "where IDPERSONA = #{idpersona,jdbcType=DECIMAL}",
          "and IDCURSO = #{idcurso,jdbcType=DECIMAL}"
    })
    @Results({
    ...
    int updateByExampleSelective(@Param("record") ForPersonaCurso record, @Param("example") ForPersonaCursoExample example);
     ...
     */
    @Update({
        "update FOR_PERSONA_CURSO",
        "set IDROL = #{idrol,jdbcType=DECIMAL},",
          "USUMODIFICACION = #{usumodificacion,jdbcType=DECIMAL},",
          "FECHAMODIFICACION = #{fechamodificacion,jdbcType=TIMESTAMP},",
          "IDINSTITUCION = #{idinstitucion,jdbcType=DECIMAL},",
          "IDTIPOCOSTE = #{idtipocoste,jdbcType=DECIMAL},",
          "TARIFA = #{tarifa,jdbcType=DECIMAL},",
          "TUTOR = #{tutor,jdbcType=DECIMAL}",
        "where IDPERSONA = #{idpersona,jdbcType=DECIMAL}",
          "and IDCURSO = #{idcurso,jdbcType=DECIMAL}"
    })
