...
import org.itcgae.siga.db.entities.ScsProfesionExample.Criteria;
import org.itcgae.siga.db.entities.ScsProfesionExample.Criterion;
import org.itcgae.siga.db.entities.ScsProfesionExample;

public class ScsProfesionSqlProvider {
     ...
     */
    public String countByExample(ScsProfesionExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("SCS_PROFESION");
     ...
     * @mbg.generated Thu Oct 24 16:36:39 CEST 2019
     */
    public String deleteByExample(ScsProfesionExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("SCS_PROFESION");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Thu Oct 24 16:36:39 CEST 2019
     */
    public String insertSelective(ScsProfesion record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("SCS_PROFESION");
     ...
     * @mbg.generated Thu Oct 24 16:36:39 CEST 2019
     */
    public String selectByExample(ScsProfesionExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("IDPROFESION");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ScsProfesion record = (ScsProfesion) parameter.get("record");
        ScsProfesionExample example = (ScsProfesionExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("SCS_PROFESION");
     ...
     * @mbg.generated Thu Oct 24 16:36:39 CEST 2019
     */
    public String updateByPrimaryKeySelective(ScsProfesion record) {
        SQL sql = new SQL();
        sql.UPDATE("SCS_PROFESION");
        ...
        sql.WHERE("IDPROFESION = #{idprofesion,jdbcType=DECIMAL}");
     ...
     * @mbg.generated Thu Oct 24 16:36:39 CEST 2019
     */
    protected void applyWhere(SQL sql, ScsProfesionExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
