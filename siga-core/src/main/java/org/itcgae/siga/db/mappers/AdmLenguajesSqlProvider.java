...
import org.itcgae.siga.db.entities.AdmLenguajesExample.Criteria;
import org.itcgae.siga.db.entities.AdmLenguajesExample.Criterion;

public class AdmLenguajesSqlProvider {
	 ...
	 */
	public String countByExample(AdmLenguajesExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("ADM_LENGUAJES");
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String deleteByExample(AdmLenguajesExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("ADM_LENGUAJES");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String insertSelective(AdmLenguajes record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("ADM_LENGUAJES");
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String selectByExample(AdmLenguajesExample example) {
		SQL sql = new SQL();
		if (example != null && example.isDistinct()) {
			sql.SELECT_DISTINCT("IDLENGUAJE");
		} else {
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		AdmLenguajes record = (AdmLenguajes) parameter.get("record");
		AdmLenguajesExample example = (AdmLenguajesExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("ADM_LENGUAJES");
		if (record.getIdlenguaje() != null) {
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String updateByPrimaryKeySelective(AdmLenguajes record) {
		SQL sql = new SQL();
		sql.UPDATE("ADM_LENGUAJES");
		if (record.getDescripcion() != null) {
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	protected void applyWhere(SQL sql, AdmLenguajesExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
