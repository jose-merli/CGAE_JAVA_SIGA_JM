...
public class ScsGuardiasturnoSqlProvider {
	...
	public String insertSelective(ScsGuardiasturno record) {
		...
		if (record.getRequeridavalidacion() != null) {
			sql.VALUES("REQUERIDAVALIDACION", "#{requeridavalidacion,jdbcType=VARCHAR}");
		}
		return sql.toString();
	}
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		...
		if (record.getRequeridavalidacion() != null) {
			sql.SET("REQUERIDAVALIDACION = #{record.requeridavalidacion,jdbcType=VARCHAR}");
		}
	...
	public String updateByPrimaryKeySelective(ScsGuardiasturno record) {
		...
		if (record.getRequeridavalidacion() != null) {
			sql.SET("REQUERIDAVALIDACION = #{requeridavalidacion,jdbcType=VARCHAR}");
		}
