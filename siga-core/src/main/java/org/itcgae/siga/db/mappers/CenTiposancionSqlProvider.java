...
import org.itcgae.siga.db.entities.CenTiposancionExample.Criteria;
import org.itcgae.siga.db.entities.CenTiposancionExample.Criterion;

public class CenTiposancionSqlProvider {
	 ...
	 */
	public String countByExample(CenTiposancionExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("CEN_TIPOSANCION");
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String deleteByExample(CenTiposancionExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("CEN_TIPOSANCION");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String insertSelective(CenTiposancion record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("CEN_TIPOSANCION");
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String selectByExample(CenTiposancionExample example) {
		SQL sql = new SQL();
		if (example != null && example.isDistinct()) {
			sql.SELECT_DISTINCT("IDTIPOSANCION");
		} else {
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		CenTiposancion record = (CenTiposancion) parameter.get("record");
		CenTiposancionExample example = (CenTiposancionExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("CEN_TIPOSANCION");
		if (record.getIdtiposancion() != null) {
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	public String updateByPrimaryKeySelective(CenTiposancion record) {
		SQL sql = new SQL();
		sql.UPDATE("CEN_TIPOSANCION");
		if (record.getCodigoext() != null) {
		...
		sql.WHERE("IDTIPOSANCION = #{idtiposancion,jdbcType=DECIMAL}");
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Mar 14 18:23:45 CET 2018
	 */
	protected void applyWhere(SQL sql, CenTiposancionExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
