...
public interface ForInscripcionMapper {
	...
	@Insert({ "insert into FOR_INSCRIPCION (IDINSCRIPCION, IDINSTITUCION, ", "IDESTADOINSCRIPCION, FECHASOLICITUD, ",
			...
			"FECHABAJA, PAGADA)", "values (#{idinscripcion,jdbcType=DECIMAL}, #{idinstitucion,jdbcType=DECIMAL}, ",
	...
	@Select({ "select", "IDINSCRIPCION, IDINSTITUCION, IDESTADOINSCRIPCION, FECHASOLICITUD, CALIFICACION, ",
			"IDPERSONA, IDCURSO, IDCALIFICACION, USUMODIFICACION, FECHAMODIFICACION, FECHABAJA, ", "PAGADA",
