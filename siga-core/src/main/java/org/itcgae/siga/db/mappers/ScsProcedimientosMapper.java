...
public interface ScsProcedimientosMapper {
     ...
     */
    @Delete({
        "delete from SCS_PROCEDIMIENTOS",
     ...
     */
    @Insert({
        "insert into SCS_PROCEDIMIENTOS (IDINSTITUCION, IDPROCEDIMIENTO, ",
        "NOMBRE, FECHAMODIFICACION, ",
        "USUMODIFICACION, PRECIO, ",
        "IDJURISDICCION, CODIGO, ",
        "COMPLEMENTO, VIGENTE, ",
        "ORDEN, CODIGOEXT, ",
        "PERMITIRANIADIRLETRADO, FECHADESDEVIGOR, ",
        "FECHAHASTAVIGOR)",
    ...
    @Select({
        "select",
        "IDINSTITUCION, IDPROCEDIMIENTO, NOMBRE, FECHAMODIFICACION, USUMODIFICACION, ",
    ...
    int updateByExampleSelective(@Param("record") ScsProcedimientos record, @Param("example") ScsProcedimientosExample example);
    ...
    @Update({
        ...
        "set NOMBRE = #{nombre,jdbcType=VARCHAR},",
          ...
          "COMPLEMENTO = #{complemento,jdbcType=VARCHAR},",
          "VIGENTE = #{vigente,jdbcType=VARCHAR},",
