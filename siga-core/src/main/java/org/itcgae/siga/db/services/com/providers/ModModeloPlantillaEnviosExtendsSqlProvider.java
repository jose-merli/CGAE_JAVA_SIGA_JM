...
public class ModModeloPlantillaEnviosExtendsSqlProvider {
	...
	public String selectPlantillasModelo(String idModelo, Short idInstitucion, String idLenguaje){
		...
		sql.SELECT("PLANTILLA.NOMBRE, PLANTILLA.IDTIPOENVIOS, MODELO.PORDEFECTO, MODELO.FECHABAJA,"
		...
		sql.JOIN("ENV_PLANTILLASENVIOS PLANTILLA ON PLANTILLA.IDPLANTILLAENVIOS = MODELO.IDPLANTILLAENVIOS AND PLANTILLA.IDINSTITUCION = '"+ idInstitucion +"'");
