...
public class ModModeloPlantillaEnviosExtendsSqlProvider {
	...
	public String selectPlantillasModelo(String idModelo, String idLenguaje){
		SQL sql = new SQL();
		
		sql.SELECT("PLANTILLA.NOMBRE, PLANTILLA.IDTIPOENVIOS, MODELO.PORDEFECTO,"
	...
	public String selectPlantillasModeloHIST(String idModelo, String idLenguaje){
		SQL sql = new SQL();
