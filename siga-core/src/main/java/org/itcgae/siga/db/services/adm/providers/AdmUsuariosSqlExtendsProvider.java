...
//		}
	...
	public String getAccessControls(ControlRequestItem request){
		...
		sql.SELECT("DECODE(MAX(DECODE(ACCESO.DERECHOACCESO,1,5,ACCESO.DERECHOACCESO)),5,1,MAX(DECODE(ACCESO.DERECHOACCESO,1,5,ACCESO.DERECHOACCESO))) AS DERECHOACCESO");
