...
public interface CenSolicitudincorporacionMapper {
	...
	@Insert({ "insert into CEN_SOLICITUDINCORPORACION (IDSOLICITUD, FECHASOLICITUD, ", "IDTRATAMIENTO, NOMBRE, ",
			...
			"ABONOCARGO, RESIDENTE, ", "IDPERSONA, FECHAALTA, ", "IDPERSONATEMP, IDDIRECCIONTEMP, ", "IBAN)",
			...
			"#{idpersonatemp,jdbcType=DECIMAL}, #{iddirecciontemp,jdbcType=DECIMAL}, ", "#{iban,jdbcType=VARCHAR})" })
	...
	@Select({ "select",
			...
			"IDPERSONATEMP, IDDIRECCIONTEMP, IBAN", "from CEN_SOLICITUDINCORPORACION",
