...
import org.itcgae.siga.db.entities.ScsDocumentaciondesignaExample.Criteria;
import org.itcgae.siga.db.entities.ScsDocumentaciondesignaExample.Criterion;
import org.itcgae.siga.db.entities.ScsDocumentaciondesignaExample;

public class ScsDocumentaciondesignaSqlProvider {
    /**
     ...
     */
    public String countByExample(ScsDocumentaciondesignaExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("SCS_DOCUMENTACIONDESIGNA");
     ...
     * @mbg.generated Mon May 03 17:46:48 CEST 2021
     */
    public String deleteByExample(ScsDocumentaciondesignaExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("SCS_DOCUMENTACIONDESIGNA");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Mon May 03 17:46:48 CEST 2021
     */
    public String insertSelective(ScsDocumentaciondesigna record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("SCS_DOCUMENTACIONDESIGNA");
        
        if (record.getIddocumentaciondes() != null) {
            sql.VALUES("IDDOCUMENTACIONDES", "#{iddocumentaciondes,jdbcType=DECIMAL}");
        }
     ...
     * @mbg.generated Mon May 03 17:46:48 CEST 2021
     */
    public String selectByExample(ScsDocumentaciondesignaExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("IDDOCUMENTACIONDES");
        } else {
            sql.SELECT("IDDOCUMENTACIONDES");
        }
        ...
        sql.FROM("SCS_DOCUMENTACIONDESIGNA");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ScsDocumentaciondesigna record = (ScsDocumentaciondesigna) parameter.get("record");
        ScsDocumentaciondesignaExample example = (ScsDocumentaciondesignaExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("SCS_DOCUMENTACIONDESIGNA");
        
        if (record.getIddocumentaciondes() != null) {
            sql.SET("IDDOCUMENTACIONDES = #{record.iddocumentaciondes,jdbcType=DECIMAL}");
        }
     ...
     * @mbg.generated Mon May 03 17:46:48 CEST 2021
     */
    public String updateByPrimaryKeySelective(ScsDocumentaciondesigna record) {
        SQL sql = new SQL();
        sql.UPDATE("SCS_DOCUMENTACIONDESIGNA");
        ...
        sql.WHERE("IDDOCUMENTACIONDES = #{iddocumentaciondes,jdbcType=DECIMAL}");
     ...
     * @mbg.generated Mon May 03 17:46:48 CEST 2021
     */
    protected void applyWhere(SQL sql, ScsDocumentaciondesignaExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
