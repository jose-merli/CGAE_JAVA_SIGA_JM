...
public class FicherosAdeudosItem {
	 ...
	 */
	public String getIdDisqueteCargos() {
		return idDisqueteCargos;
	}
	/**
	 * @param idDisqueteCargos the idDisqueteCargos to set
	 */
	public void setIdDisqueteCargos(String idDisqueteCargos) {
	...
	/**
	 * @return the idseriefacturacion
	 */
	public String getIdseriefacturacion() {
		return idseriefacturacion;
	}
	/**
	 * @param idseriefacturacion the idseriefacturacion to set
	 */
	...
	/**
	 * @param idSufijo the idSufijo to set
	 */
	...
	/**
	 * @return the totalRemesa
	 */
	public String getTotalRemesa() {
		return totalRemesa;
	}
	/**
	 * @param totalRemesa the totalRemesa to set
	 */
	public void setTotalRemesa(String totalRemesa) {
	...
	public int hashCode() {
		...
		result = prime * result + ((idSufijo == null) ? 0 : idSufijo.hashCode());
		result = prime * result + ((idprogramacion == null) ? 0 : idprogramacion.hashCode());
		result = prime * result + ((idseriefacturacion == null) ? 0 : idseriefacturacion.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FicherosAdeudosItem other = (FicherosAdeudosItem) obj;
		...
		if (iban == null) {
			...
			return false;
		if (idDisqueteCargos == null) {
			if (other.idDisqueteCargos != null)
				return false;
		} else if (!idDisqueteCargos.equals(other.idDisqueteCargos))
			return false;
		if (idInstitucion == null) {
			...
			return false;
		if (idSufijo == null) {
			if (other.idSufijo != null)
				return false;
		} else if (!idSufijo.equals(other.idSufijo))
			return false;
		if (idprogramacion == null) {
			if (other.idprogramacion != null)
				return false;
		} else if (!idprogramacion.equals(other.idprogramacion))
			return false;
		if (idseriefacturacion == null) {
			if (other.idseriefacturacion != null)
				return false;
		} else if (!idseriefacturacion.equals(other.idseriefacturacion))
			return false;
		...
		if (numerolineas == null) {
			if (other.numerolineas != null)
				return false;
		} else if (!numerolineas.equals(other.numerolineas))
			return false;
		if (origen == null) {
			...
			return false;
		if (sufijo == null) {
			if (other.sufijo != null)
				return false;
		} else if (!sufijo.equals(other.sufijo))
			return false;
		if (totalRemesa == null) {
			if (other.totalRemesa != null)
				return false;
		} else if (!totalRemesa.equals(other.totalRemesa))
			return false;
		return true;
	}
	@Override
