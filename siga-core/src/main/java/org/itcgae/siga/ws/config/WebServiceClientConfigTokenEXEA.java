...
public class WebServiceClientConfigTokenEXEA {
    ...
    @Bean
    public TokenEXEAClient webServiceTemplateTokenEXEA() throws SOAPException, KeyManagementException, NoSuchAlgorithmException {
        TokenEXEAClient client = new TokenEXEAClient();
        WebServiceTemplate webServiceTemplate = new WebServiceTemplate();
        ...
        webServiceTemplate.setDefaultUri("http://exeadesv7.abogacia.es:8889/services");
        webServiceTemplate.setMarshaller(new XmlBeansMarshaller());
        webServiceTemplate.setUnmarshaller(new XmlBeansMarshaller());
