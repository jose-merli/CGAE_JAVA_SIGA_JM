...
public class WebServiceClientConfigRegTel {
    ...
    @Bean
    public RegTelClient webServiceTemplateRegTel() throws SOAPException, KeyManagementException, NoSuchAlgorithmException {
        RegTelClient client = new RegTelClient();
        WebServiceTemplate webServiceTemplate = new WebServiceTemplate();
        ...
        webServiceTemplate.setDefaultUri("http://192.168.18.9:7037/wseregtel/RegtelService");
        webServiceTemplate.setMarshaller(new XmlBeansMarshaller());
        webServiceTemplate.setUnmarshaller(new XmlBeansMarshaller());
