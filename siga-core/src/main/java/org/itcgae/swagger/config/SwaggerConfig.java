...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
	...
	@Bean
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).protocols(Collections.singleton("http")).select()
	...
	private ApiInfo getApiInfo() {
		...
		return new ApiInfo(
				...
				"API CGAE-SIGA DELOITTE",

				"API CGAE-SIGA DELOITTE",

				"AlejandroVenegas-1.0",

				"www.deloitte.com",

				new Contact("Alejandro Venegas", "https://deloitte.es", "avenegascaleron@deloitte.es"),
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		...
		registry.addRedirectViewController(context + "/swagger-resources/configuration/ui",
				"/swagger-resources/configuration/ui");

		registry.addRedirectViewController(context + "/swagger-resources/configuration/security",
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler(context + "/swagger-ui.html**")
				.addResourceLocations("classpath:/META-INF/resources/swagger-ui.html");

		registry.addResourceHandler(context + "/webjars/**")
