...
ALTER TABLE age_evento
    ADD CONSTRAINT age_evento_age_diassemana_fk FOREIGN KEY ( iddiassemana )
        REFERENCES age_diassemana ( iddiassemana );
