spool 8-CREATE_TABLE_REG_MERCANTIL.log
prompt 8-CREATE_TABLE_REG_MERCANTIL.log
...
prompt .
  ...
  ALTER TABLE "USCGAE"."CEN_NOCOLEGIADO" ADD CONSTRAINT FK_DATOS_SOCIEDAD_MERCANTIL FOREIGN KEY (ID_DATOS_REG) REFERENCES "USCGAE"."CEN_REG_MERCANTIL"(ID_DATOS_REG) deferrable;
